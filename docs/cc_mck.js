...
Main.prototype = {
	...
	,setupNav: function() {
		...
		rdiv.onclick = function() {
			haxe_Log.trace("right",{ fileName : "src/Main.hx", lineNumber : 76, className : "Main", methodName : "setupNav"});
			_gthis.count++;
...
art_CC028.prototype = $extend(art_CCBase.prototype,{
	...
	,drawShape: function() {
		...
		var int = Std.parseInt(StringTools.replace(colorArray[1],"#","0x"));
		var _color1 = { r : int >> 16 & 255, g : int >> 8 & 255, b : int & 255};
		var int = Std.parseInt(StringTools.replace(colorArray[2],"#","0x"));
		var _color2 = { r : int >> 16 & 255, g : int >> 8 & 255, b : int & 255};
		var int = Std.parseInt(StringTools.replace(colorArray[3],"#","0x"));
		var _color3 = { r : int >> 16 & 255, g : int >> 8 & 255, b : int & 255};
		var int = Std.parseInt(StringTools.replace(colorArray[4],"#","0x"));
		...
		var _color0 = this.convertToHexToGray(colorArray[0]);
		var _color1 = this.convertToHexToGray(colorArray[1]);
		var _color2 = this.convertToHexToGray(colorArray[2]);
		var _color3 = this.convertToHexToGray(colorArray[3]);
		var _color4 = this.convertToHexToGray(colorArray[4]);
		var px = 10;
		var _w = Math.round((this.grid.cellWidth - px) / _colorA.length);
		var point = this.grid.array[1];
		var _colorA = [_color0,_color1,_color2,_color3,_color4];
		var _g = 0;
		var _g1 = _colorA.length;
		while(_g < _g1) {
		...
		var color = this.convertToHex2(colorArray[0]);
		var array1 = { hex : array, gray : new hxColorToolkit_spaces_Gray().setColor(color).getColor()};
		var array = this.convertToHex2(colorArray[1]);
		var color = this.convertToHex2(colorArray[1]);
		var array2 = { hex : array, gray : new hxColorToolkit_spaces_Gray().setColor(color).getColor()};
		var array = this.convertToHex2(colorArray[2]);
		var color = this.convertToHex2(colorArray[2]);
		var array3 = { hex : array, gray : new hxColorToolkit_spaces_Gray().setColor(color).getColor()};
		var array = this.convertToHex2(colorArray[3]);
		var color = this.convertToHex2(colorArray[3]);
		var array4 = { hex : array, gray : new hxColorToolkit_spaces_Gray().setColor(color).getColor()};
		var array = this.convertToHex2(colorArray[4]);
		var color = this.convertToHex2(colorArray[4]);
		var array5 = [array1,array2,array3,array4,{ hex : array, gray : new hxColorToolkit_spaces_Gray().setColor(color).getColor()}];
		$global.console.log("An Array with objects",array5);
		var copy = array5.slice();
		haxe_ds_ArraySort.sort(copy,function(a,b) {
			if(a.gray < b.gray) {
				return 1;
			} else if(a.gray > b.gray) {
		...
		$global.console.log("An Array with objects",copy);
		var point = this.grid.array[2];
		var _g = 0;
		var _g1 = copy.length;
		while(_g < _g1) {
			var j = _g++;
			var offsetX = j * _w;
			var color = copy[j].gray;
			var __c = new hxColorToolkit_spaces_RGB(color >> 16 & 255,color >> 8 & 255,color & 255);
			cc_CanvasTools.fillColour(this.ctx,Math.round(__c.get_red()),Math.round(__c.get_green()),Math.round(__c.get_blue()));
			this.ctx.fillRect(offsetX + point.x,point.y,_w,this.grid.cellHeight - px);
		}
		var point = this.grid.array[3];
		var _g = 0;
		var _g1 = copy.length;
		while(_g < _g1) {
			var j = _g++;
			var offsetX = j * _w;
			var color = copy[j].hex;
			var __c = new hxColorToolkit_spaces_RGB(color >> 16 & 255,color >> 8 & 255,color & 255);
			cc_CanvasTools.fillColour(this.ctx,Math.round(__c.get_red()),Math.round(__c.get_green()),Math.round(__c.get_blue()));
			this.ctx.fillRect(offsetX + point.x,point.y,_w,this.grid.cellHeight - px);
		}
...
hxColorToolkit_schemes_ColorWheelScheme.prototype = {
	clone: function() {
		throw haxe_Exception.thrown("need to be overrided");
	}
	,getColor: function(index) {
		return this._colors[index];
	}
	,iterator: function() {
		return new haxe_iterators_ArrayIterator(this._colors);
	}
	...
	,generate: function() {
		throw haxe_Exception.thrown("Method must be called by child class");
	}
...
hxColorToolkit_schemes_Compound.prototype = $extend(hxColorToolkit_schemes_ColorWheelScheme.prototype,{
	...
	,generate: function() {
		...
		var x = _primaryHSB.get_brightness();
		c2.set_brightness(x - 40 < 10 ? x + 40 : x - 40);
		var x = _primaryHSB.get_saturation();
		c2.set_saturation(x - 40 < 20 ? x + 40 : x - 40);
		...
		var x = _primaryHSB.get_saturation();
		c3.set_saturation(x - 25 < 10 ? x + 25 : x - 25);
		...
		var x = _primaryHSB.get_brightness();
		c4.set_brightness(x - 30 < 60 ? x + 30 : x - 30);
		var x = _primaryHSB.get_saturation();
		c4.set_saturation(x - 10 < 80 ? x + 10 : x - 10);
		...
		var x = _primaryHSB.get_brightness();
		c5.set_brightness(x - 40 < 20 ? x + 40 : x - 40);
		var x = _primaryHSB.get_saturation();
		c5.set_saturation(x - 10 < 80 ? x + 10 : x - 10);
...
hxColorToolkit_spaces_XYZ.prototype = {
	...
	,setValue: function(channel,val) {
		if(channel < 0 || channel >= this.numOfChannels) {
			throw haxe_Exception.thrown("no such channel");
		}
	...
	,maxValue: function(channel) {
		...
		case 2:
			return 108.883;
		default:
			throw haxe_Exception.thrown("XYZ does not have channel " + channel);
		}
	}
	,get_x: function() {
		return this.getValue(0);
...
lib_model_constants_Onom.prototype = {
	...
	,getAvailable: function() {
		var str = "";
		var value = haxe_ds_StringMap.keysIterator(this.mono.h);
		while(value.hasNext()) {
...
mloader_HttpLoader.prototype = $extend(mloader_LoaderBase.prototype,{
	...
	,addHeaders: function() {
		var name = haxe_ds_StringMap.keysIterator(this.headers.h);
		while(name.hasNext()) {
			var name1 = name.next();
			this.http.setHeader(name1,this.headers.h[name1]);
		}
	}
