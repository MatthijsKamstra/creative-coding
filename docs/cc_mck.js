...
cc_draw_Text.create = function(ctx,text) {
	var Text1 = new cc_draw_Text(ctx,text);
	return Text1;
};
...
cc_tool_ExportFile.downloadImageBg = function(ctx,isJpg,fileName) {
	...
	if(!HTMLCanvasElement.prototype.toBlob) {
		haxe_Log.trace("There is no blob",{ fileName : "cc/tool/ExportFile.hx", lineNumber : 182, className : "cc.tool.ExportFile", methodName : "downloadImageBg"});
		link.href = ctx.canvas.toDataURL(isJpg ? "image/jpeg" : "",1);
		link.click();
		link.remove();
	} else {
		haxe_Log.trace("Attack of the blob",{ fileName : "cc/tool/ExportFile.hx", lineNumber : 188, className : "cc.tool.ExportFile", methodName : "downloadImageBg"});
...
cc_tool_export_ExportZip.prototype = $extend(cc_tool_export_ExportWrapperBase.prototype,{
	...
	,exportLite: function(filename,imageStringArray) {
		...
		haxe_Log.trace("Generate zip file - " + (new Date().getTime() - startT) / 1000 + "sec",{ fileName : "cc/tool/export/ExportZip.hx", lineNumber : 105, className : "cc.tool.export.ExportZip", methodName : "exportLite"});
		var updateCallback = function(metadata) {
			if(_gthis._isDebug) {
				window.console.log("progression: " + metadata.percent.toFixed(2) + " %");
			}
	...
	,onLoadComplete: function(str,callback,callbackArray) {
		...
		case "jszip":
			...
			break;
		default:
			haxe_Log.trace("case '" + str + "': trace ('" + str + "');",{ fileName : "cc/tool/export/ExportZip.hx", lineNumber : 157, className : "cc.tool.export.ExportZip", methodName : "onLoadComplete"});
		}
...
cc_util_GridUtil.prototype = {
	...
	,calc: function() {
		haxe_Log.trace("WIP",{ fileName : "cc/util/GridUtil.hx", lineNumber : 176, className : "cc.util.GridUtil", methodName : "calc"});
		return this;
	}
...
cc_util_MathUtil.pythagoreanTheorem = function(a,b,c) {
	if(a == null && b == null && c == null) {
		haxe_Log.trace("Really? Perhaps you should use some data",{ fileName : "cc/util/MathUtil.hx", lineNumber : 79, className : "cc.util.MathUtil", methodName : "pythagoreanTheorem"});
		return 0;
	}
	var value = 0.0;
	if(c == null || c == 0) {
