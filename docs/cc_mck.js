...
var Main = function() {
	...
	window.document.addEventListener("DOMContentLoaded",function(event) {
		window.console.log("" + lib_model_constants_App.NAME + " :: build: " + "2020-01-10 11:13:08");
		_gthis.setupCC();
		_gthis.setupNav();
	});
};
...
Main.prototype = {
	...
	,setupNav: function() {
		...
		ldiv.onclick = function() {
			haxe_Log.trace("left",{ fileName : "src/Main.hx", lineNumber : 67, className : "Main", methodName : "setupNav"});
			_gthis.count--;
			_gthis.changeHash();
		};
		...
		rdiv.onclick = function() {
			haxe_Log.trace("right",{ fileName : "src/Main.hx", lineNumber : 74, className : "Main", methodName : "setupNav"});
			_gthis.count++;
			_gthis.changeHash();
		};
	...
	,update: function() {
		...
		if(this.settings.get_type() == "svg") {
			...
			while(_g2 < _g11) {
				...
				haxe_Log.trace(base1.type,{ fileName : "Sketcher.hx", lineNumber : 428, className : "Sketcher", methodName : "update"});
...
art_CC004.prototype = $extend(art_CCBase.prototype,{
	...
	,drawBall: function() {
		...
		while(_g < _g1) {
			...
			var _g2 = 0;
			var _g11 = this.ballArray.length;
			while(_g2 < _g11) {
				var j = _g2++;
...
art_CC007.prototype = $extend(art_CCBase.prototype,{
	...
	,onCompleteHandler: function(value) {
		var totalTime = Date.now() / 1000 - this.startTime;
	...
	,ballAnimate: function(ball) {
		...
		var _this4 = _this2;
		_this4._options.onComplete = $bind(this,this.ballAnimate);
		_this4._options.onCompleteParams = [ball];
		var _this5 = _this4;
		_this5._easing = cc_lets_easing_Sine.get_easeInOut();
	}
	,createBall: function() {
...
art_CC008.prototype = $extend(art_CCBase.prototype,{
	...
	,setup: function() {
		...
		var objValue1 = 0;
		if(Object.prototype.hasOwnProperty.call(_this2._target,"x")) {
			objValue1 = Reflect.getProperty(_this2._target,"x");
		}
		var _range1 = { key : "x", from : _this2._isFrom ? value1 : objValue1, to : !_this2._isFrom ? value1 : objValue1};
		var _this3 = _this2._props;
		if(__map_reserved["x"] != null) {
			_this3.setReserved("x",_range1);
		} else {
			_this3.h["x"] = _range1;
		}
		if(_this2._isFrom) {
		...
		if(Object.prototype.hasOwnProperty.call(_this5._target,"x")) {
			objValue2 = Reflect.getProperty(_this5._target,"x");
		}
		var _range2 = { key : "x", from : _this5._isFrom ? value2 : objValue2, to : !_this5._isFrom ? value2 : objValue2};
		var _this6 = _this5._props;
		if(__map_reserved["x"] != null) {
			_this6.setReserved("x",_range2);
		} else {
			_this6.h["x"] = _range2;
		}
		if(_this5._isFrom) {
		...
		if(Object.prototype.hasOwnProperty.call(_this8._target,"x")) {
			objValue3 = Reflect.getProperty(_this8._target,"x");
		}
		var _range3 = { key : "x", from : _this8._isFrom ? value3 : objValue3, to : !_this8._isFrom ? value3 : objValue3};
		var _this9 = _this8._props;
		if(__map_reserved["x"] != null) {
			_this9.setReserved("x",_range3);
		} else {
			_this9.h["x"] = _range3;
		}
		if(_this8._isFrom) {
		...
		var objValue4 = 0;
		if(Object.prototype.hasOwnProperty.call(_this10._target,"y")) {
			objValue4 = Reflect.getProperty(_this10._target,"y");
		}
		var _range4 = { key : "y", from : _this10._isFrom ? value4 : objValue4, to : !_this10._isFrom ? value4 : objValue4};
		var _this11 = _this10._props;
		if(__map_reserved["y"] != null) {
			_this11.setReserved("y",_range4);
		} else {
			_this11.h["y"] = _range4;
		}
		if(_this10._isFrom) {
			_this10.updateProperties(0);
		}
		var _this12 = _this10;
		_this12._isYoyo = true;
		...
		var objValue5 = 0;
		if(Object.prototype.hasOwnProperty.call(_this13._target,"x")) {
			objValue5 = Reflect.getProperty(_this13._target,"x");
		}
		var _range5 = { key : "x", from : _this13._isFrom ? value5 : objValue5, to : !_this13._isFrom ? value5 : objValue5};
		var _this14 = _this13._props;
		if(__map_reserved["x"] != null) {
			_this14.setReserved("x",_range5);
		} else {
			_this14.h["x"] = _range5;
		}
		if(_this13._isFrom) {
		...
		var _this15 = _this13;
		var objValue6 = 0;
		if(Object.prototype.hasOwnProperty.call(_this15._target,"rotation")) {
			objValue6 = Reflect.getProperty(_this15._target,"rotation");
		}
		var _range6 = { key : "rotation", from : _this15._isFrom ? 180 : objValue6, to : !_this15._isFrom ? 180 : objValue6};
		var _this16 = _this15._props;
		if(__map_reserved["rotation"] != null) {
			_this16.setReserved("rotation",_range6);
		} else {
			_this16.h["rotation"] = _range6;
		}
		if(_this15._isFrom) {
			_this15.updateProperties(0);
		}
		var _this17 = _this15;
		_this17._isYoyo = true;
		var _this18 = _this17;
		_this18._options.onUpdate = $bind(this,this.onUpdateHandler);
		_this18._options.onUpdateParams = [4];
		...
		var objValue7 = 0;
		if(Object.prototype.hasOwnProperty.call(_this19._target,"x")) {
			objValue7 = Reflect.getProperty(_this19._target,"x");
		}
		var _range7 = { key : "x", from : _this19._isFrom ? value6 : objValue7, to : !_this19._isFrom ? value6 : objValue7};
		var _this20 = _this19._props;
		if(__map_reserved["x"] != null) {
			_this20.setReserved("x",_range7);
		} else {
			_this20.h["x"] = _range7;
		}
		if(_this19._isFrom) {
			_this19.updateProperties(0);
		}
		var _this21 = _this19;
		var objValue8 = 0;
		if(Object.prototype.hasOwnProperty.call(_this21._target,"foobar")) {
			objValue8 = Reflect.getProperty(_this21._target,"foobar");
		}
		var _range8 = { key : "foobar", from : _this21._isFrom ? 180 : objValue8, to : !_this21._isFrom ? 180 : objValue8};
		var _this22 = _this21._props;
		if(__map_reserved["foobar"] != null) {
			_this22.setReserved("foobar",_range8);
		} else {
			_this22.h["foobar"] = _range8;
		}
		if(_this21._isFrom) {
			_this21.updateProperties(0);
		}
		var _this23 = _this21;
		_this23._options.onUpdate = $bind(this,this.onUpdateHandler);
		_this23._options.onUpdateParams = [5];
		var _this24 = _this23;
		_this24._options.onComplete = $bind(this,this.onCompleteHandler);
		_this24._options.onCompleteParams = [5];
		...
		var objValue9 = 0;
		if(Object.prototype.hasOwnProperty.call(_this25._target,"x")) {
			objValue9 = Reflect.getProperty(_this25._target,"x");
		}
		var _range9 = { key : "x", from : _this25._isFrom ? value7 : objValue9, to : !_this25._isFrom ? value7 : objValue9};
		var _this26 = _this25._props;
		if(__map_reserved["x"] != null) {
			_this26.setReserved("x",_range9);
		} else {
			_this26.h["x"] = _range9;
		}
		if(_this25._isFrom) {
			_this25.updateProperties(0);
		}
		var _this27 = _this25;
		_this27._delay = _this27.getDuration(.7);
		var _this28 = _this27;
		var objValue10 = 0;
		if(Object.prototype.hasOwnProperty.call(_this28._target,"rotation")) {
			objValue10 = Reflect.getProperty(_this28._target,"rotation");
		}
		var _range10 = { key : "rotation", from : _this28._isFrom ? 360 : objValue10, to : !_this28._isFrom ? 360 : objValue10};
		var _this29 = _this28._props;
		if(__map_reserved["rotation"] != null) {
			_this29.setReserved("rotation",_range10);
		} else {
			_this29.h["rotation"] = _range10;
		}
		if(_this28._isFrom) {
			_this28.updateProperties(0);
		}
		var _this30 = _this28;
		_this30._isYoyo = true;
		...
		var objValue11 = 0;
		if(Object.prototype.hasOwnProperty.call(_this31._target,"x")) {
			objValue11 = Reflect.getProperty(_this31._target,"x");
		}
		var _range11 = { key : "x", from : _this31._isFrom ? value8 : objValue11, to : !_this31._isFrom ? value8 : objValue11};
		var _this32 = _this31._props;
		if(__map_reserved["x"] != null) {
			_this32.setReserved("x",_range11);
		} else {
			_this32.h["x"] = _range11;
		}
		if(_this31._isFrom) {
			_this31.updateProperties(0);
		}
		var _this33 = _this31;
		var objValue12 = 0;
		if(Object.prototype.hasOwnProperty.call(_this33._target,"rotation")) {
			objValue12 = Reflect.getProperty(_this33._target,"rotation");
		}
		var _range12 = { key : "rotation", from : _this33._isFrom ? 360 : objValue12, to : !_this33._isFrom ? 360 : objValue12};
		var _this34 = _this33._props;
		if(__map_reserved["rotation"] != null) {
			_this34.setReserved("rotation",_range12);
		} else {
			_this34.h["rotation"] = _range12;
		}
		if(_this33._isFrom) {
			_this33.updateProperties(0);
		}
		var _this35 = _this33;
		_this35._isYoyo = true;
		var _this36 = _this35;
		_this36._easing = cc_lets_easing_Sine.get_easeInOut();
	}
...
art_CC009.prototype = $extend(art_CCBase.prototype,{
	...
	,onCompleteHandler: function(shape) {
		...
		var _this4 = _this2;
		var objValue2 = 0;
		if(Object.prototype.hasOwnProperty.call(_this4._target,"alpha")) {
			objValue2 = Reflect.getProperty(_this4._target,"alpha");
		}
		var _range2 = { key : "alpha", from : _this4._isFrom ? 1 : objValue2, to : !_this4._isFrom ? 1 : objValue2};
		var _this5 = _this4._props;
		if(__map_reserved["alpha"] != null) {
			_this5.setReserved("alpha",_range2);
		} else {
			_this5.h["alpha"] = _range2;
		}
		if(_this4._isFrom) {
			_this4.updateProperties(0);
		}
		var _this6 = _this4;
		var value2 = cc_util_MathUtil.randomInt(10);
		var objValue3 = 0;
		if(Object.prototype.hasOwnProperty.call(_this6._target,"size")) {
			objValue3 = Reflect.getProperty(_this6._target,"size");
		}
		var _range3 = { key : "size", from : _this6._isFrom ? value2 : objValue3, to : !_this6._isFrom ? value2 : objValue3};
		var _this7 = _this6._props;
		if(__map_reserved["size"] != null) {
			_this7.setReserved("size",_range3);
		} else {
			_this7.h["size"] = _range3;
		}
		if(_this6._isFrom) {
			_this6.updateProperties(0);
		}
		var _this8 = _this6;
		_this8._easing = cc_lets_easing_Sine.get_easeInOut();
		var _this9 = _this8;
		_this9._delay = _this9.getDuration(time);
		var _this10 = _this9;
		_this10._options.onComplete = $bind(this,this.onCompleteHandler);
		_this10._options.onCompleteParams = [shape];
	}
	,drawShape: function() {
		var _g = 0;
		var _g1 = this.shapeArray.length;
...
art_CC010.prototype = $extend(art_CCBase.prototype,{
	...
	,createText: function() {
		...
		var _range1 = { key : "y", from : _this2._isFrom ? ypos1 : objValue1, to : !_this2._isFrom ? ypos1 : objValue1};
		var _this3 = _this2._props;
		if(__map_reserved["y"] != null) {
			_this3.setReserved("y",_range1);
		} else {
		...
		var _range2 = { key : "alpha", from : _this4._isFrom ? 0 : objValue2, to : !_this4._isFrom ? 0 : objValue2};
		var _this5 = _this4._props;
		if(__map_reserved["alpha"] != null) {
			_this5.setReserved("alpha",_range2);
		} else {
		...
		var _range3 = { key : "size", from : _this6._isFrom ? 50 : objValue3, to : !_this6._isFrom ? 50 : objValue3};
		var _this7 = _this6._props;
		if(__map_reserved["size"] != null) {
			_this7.setReserved("size",_range3);
		} else {
		...
		var _this8 = _this6;
		_this8._easing = cc_lets_easing_Sine.get_easeOut();
		var _this9 = _this8;
		_this9._delay = _this9.getDuration(2);
		var Go1 = new cc_lets_Go(shape,1.0);
		Go1._isFrom = false;
		var _this10 = Go1;
		var value1 = shape.x;
		var objValue4 = 0;
		if(Object.prototype.hasOwnProperty.call(_this10._target,"x")) {
			objValue4 = Reflect.getProperty(_this10._target,"x");
		}
		var _range4 = { key : "x", from : _this10._isFrom ? value1 : objValue4, to : !_this10._isFrom ? value1 : objValue4};
		var _this11 = _this10._props;
		if(__map_reserved["x"] != null) {
			_this11.setReserved("x",_range4);
		} else {
			_this11.h["x"] = _range4;
		}
		if(_this10._isFrom) {
		...
		var _this12 = _this10;
		var objValue5 = 0;
		if(Object.prototype.hasOwnProperty.call(_this12._target,"y")) {
			objValue5 = Reflect.getProperty(_this12._target,"y");
		}
		var _range5 = { key : "y", from : _this12._isFrom ? ypos2 : objValue5, to : !_this12._isFrom ? ypos2 : objValue5};
		var _this13 = _this12._props;
		if(__map_reserved["y"] != null) {
			_this13.setReserved("y",_range5);
		} else {
			_this13.h["y"] = _range5;
		}
		if(_this12._isFrom) {
		...
		var _this14 = _this12;
		var objValue6 = 0;
		if(Object.prototype.hasOwnProperty.call(_this14._target,"alpha")) {
			objValue6 = Reflect.getProperty(_this14._target,"alpha");
		}
		var _range6 = { key : "alpha", from : _this14._isFrom ? 0 : objValue6, to : !_this14._isFrom ? 0 : objValue6};
		var _this15 = _this14._props;
		if(__map_reserved["alpha"] != null) {
			_this15.setReserved("alpha",_range6);
		} else {
			_this15.h["alpha"] = _range6;
		}
		if(_this14._isFrom) {
			_this14.updateProperties(0);
		}
		var _this16 = _this14;
		var objValue7 = 0;
		if(Object.prototype.hasOwnProperty.call(_this16._target,"size")) {
			objValue7 = Reflect.getProperty(_this16._target,"size");
		}
		var _range7 = { key : "size", from : _this16._isFrom ? 50 : objValue7, to : !_this16._isFrom ? 50 : objValue7};
		var _this17 = _this16._props;
		if(__map_reserved["size"] != null) {
			_this17.setReserved("size",_range7);
		} else {
			_this17.h["size"] = _range7;
		}
		if(_this16._isFrom) {
			_this16.updateProperties(0);
		}
		var _this18 = _this16;
		_this18._easing = cc_lets_easing_Sine.get_easeIn();
		var _this19 = _this18;
		_this19._delay = _this19.getDuration(5.5);
		return shape;
	}
	,createBall: function() {
...
art_CC011.prototype = $extend(art_CCBase.prototype,{
	...
	,onCompleteHandler: function(line) {
		...
		if(__map_reserved["radius"] != null) {
			_this1.setReserved("radius",_range);
		} else {
			_this1.h["radius"] = _range;
		}
		if(_this._isFrom) {
			_this.updateProperties(0);
		}
		...
		var _this3 = _this2;
		_this3._options.onComplete = $bind(this,this.onCompleteHandler);
		_this3._options.onCompleteParams = [line];
	}
	,onXHandler: function(obj) {
		...
		var _this1 = _this._props;
		if(__map_reserved["rotation"] != null) {
			_this1.setReserved("rotation",_range);
		} else {
			_this1.h["rotation"] = _range;
		}
		if(_this._isFrom) {
			_this.updateProperties(0);
		}
		...
		if(Object.prototype.hasOwnProperty.call(_this2._target,"size")) {
			objValue1 = Reflect.getProperty(_this2._target,"size");
		}
		var _range1 = { key : "size", from : _this2._isFrom ? value1 : objValue1, to : !_this2._isFrom ? value1 : objValue1};
		var _this3 = _this2._props;
		if(__map_reserved["size"] != null) {
			_this3.setReserved("size",_range1);
		} else {
			_this3.h["size"] = _range1;
		}
		if(_this2._isFrom) {
			_this2.updateProperties(0);
		}
		...
		var _this5 = _this4;
		_this5._options.onComplete = $bind(this,this.onXHandler);
		_this5._options.onCompleteParams = [obj];
		var _this6 = _this5;
		_this6._delay = _this6.getDuration(cc_util_MathUtil.random(0,0.5));
	}
	,setup: function() {
...
art_CC012.prototype = $extend(art_CCBase.prototype,{
	...
	,drawShape: function() {
		...
		while(_g < _g1) {
			...
			var _g2 = 0;
			var _g11 = this.shapeArray.length;
			while(_g2 < _g11) {
				var j = _g2++;
...
art_CC014.prototype = $extend(art_CCBase.prototype,{
	...
	,onCircleHandler: function(circle) {
		...
		var objValue2 = 0;
		if(Object.prototype.hasOwnProperty.call(_this4._target,"size")) {
			objValue2 = Reflect.getProperty(_this4._target,"size");
		}
		var _range2 = { key : "size", from : _this4._isFrom ? value2 : objValue2, to : !_this4._isFrom ? value2 : objValue2};
		var _this5 = _this4._props;
		if(__map_reserved["size"] != null) {
			_this5.setReserved("size",_range2);
		} else {
			_this5.h["size"] = _range2;
		}
		if(_this4._isFrom) {
			_this4.updateProperties(0);
		}
		var _this6 = _this4;
		var objValue3 = 0;
		if(Object.prototype.hasOwnProperty.call(_this6._target,"stroke")) {
			objValue3 = Reflect.getProperty(_this6._target,"stroke");
		}
		var _range3 = { key : "stroke", from : _this6._isFrom ? r : objValue3, to : !_this6._isFrom ? r : objValue3};
		var _this7 = _this6._props;
		if(__map_reserved["stroke"] != null) {
			_this7.setReserved("stroke",_range3);
		} else {
			_this7.h["stroke"] = _range3;
		}
		if(_this6._isFrom) {
			_this6.updateProperties(0);
		}
		...
		_this8._easing = cc_lets_easing_Sine.get_easeInOut();
		var _this9 = _this8;
		_this9._options.onComplete = $bind(this,this.onCircleHandler);
		_this9._options.onCompleteParams = [circle];
		var _this10 = _this9;
		_this10._delay = _this10.getDuration(cc_util_MathUtil.random(0,2));
	}
	,drawShape: function() {
...
art_CC018.prototype = $extend(art_CCBase.prototype,{
	...
	,onYoYoHandler: function(circle) {
		...
		var _this4 = _this3;
		_this4._options.onComplete = $bind(this,this.onYoYoHandler);
...
art_CC024.prototype = $extend(art_CCBase.prototype,{
	...
	,drawShape: function() {
		...
		while(_g < _g1) {
			...
			cc_CanvasTools.line(this.ctx,sh.x,sh.y,sh2.x,sh2.y);
			var _g2 = 0;
			var _g11 = this.shapeArray2.length;
			while(_g2 < _g11) {
				var j = _g2++;
...
art_CC026.prototype = $extend(art_CCBase.prototype,{
	onAnimateHandler: function(circle) {
		...
		var _this2 = _this1._props;
		if(__map_reserved["x"] != null) {
			_this2.setReserved("x",_range);
		} else {
			_this2.h["x"] = _range;
		}
		if(_this1._isFrom) {
		...
		var _this3 = _this1;
		var objValue1 = 0;
		if(Object.prototype.hasOwnProperty.call(_this3._target,"y")) {
			objValue1 = Reflect.getProperty(_this3._target,"y");
		}
		var _range1 = { key : "y", from : _this3._isFrom ? starty : objValue1, to : !_this3._isFrom ? starty : objValue1};
		var _this4 = _this3._props;
		if(__map_reserved["y"] != null) {
			_this4.setReserved("y",_range1);
		} else {
			_this4.h["y"] = _range1;
		}
		if(_this3._isFrom) {
		...
		var _this5 = _this3;
		_this5._easing = cc_lets_easing_Sine.get_easeOut();
		var _this6 = _this5;
		_this6._options.onComplete = $bind(this,this.onCompleteHandler);
		_this6._options.onCompleteParams = [circle];
	}
...
art_CC027.prototype = $extend(art_CCBase.prototype,{
	onAnimateHandler: function(circle) {
		...
		var _this5 = _this3;
		_this5._easing = cc_lets_easing_Quart.get_easeOut();
		var _this6 = _this5;
		_this6._options.onComplete = $bind(this,this.onCompleteHandler);
		_this6._options.onCompleteParams = [circle];
	}
...
art_CC028.prototype = $extend(art_CCBase.prototype,{
	loaded: function(event) {
		...
		case 4:
			var error = _g.error;
			haxe_Log.trace(error,{ fileName : "src/art/CC028.hx", lineNumber : 35, className : "art.CC028", methodName : "loaded"});
			break;
		default:
		}
	}
	...
	,setup: function() {
		var _gthis = this;
		haxe_Log.trace("setup: " + this.toString(),{ fileName : "src/art/CC028.hx", lineNumber : 170, className : "art.CC028", methodName : "setup"});
		...
		window.addEventListener(Global.KEY_DOWN,function(e) {
			...
			if(e.key == "s") {
				...
				var arrayString500 = [];
				var _g = 0;
				var _g1 = _gthis.exportIntArray.length;
				while(_g < _g1) {
					var i = _g++;
				...
				haxe_Log.trace("case '" + e.key + "': trace ('" + e.key + "');",{ fileName : "src/art/CC028.hx", lineNumber : 204, className : "art.CC028", methodName : "setup"});
			}
		},false);
	}
	,draw: function() {
		haxe_Log.trace("draw: " + this.toString(),{ fileName : "src/art/CC028.hx", lineNumber : 210, className : "art.CC028", methodName : "draw"});
		this.drawShape();
		this.stop();
	}
...
art_CC047.prototype = $extend(art_CCBase.prototype,{
	...
	,onAnimateHandler: function() {
		...
		var _range1 = { key : "y", from : _this3._isFrom ? ypos : objValue1, to : !_this3._isFrom ? ypos : objValue1};
		var _this4 = _this3._props;
		if(__map_reserved["y"] != null) {
			_this4.setReserved("y",_range1);
		} else {
		...
		_this5._easing = cc_lets_easing_Sine.get_easeInOut();
		var _this6 = _this5;
		_this6._options.onComplete = $bind(this,this.onAnimateHandler);
		_this6._options.onCompleteParams = null;
		this.go = _this6;
	}
	,drawShape: function() {
...
art_CC049.prototype = $extend(art_CCBase.prototype,{
	...
	,drawShape: function() {
		...
		while(_g < _g1) {
			...
			var _g2 = 0;
			var _g11 = charPointArray.length;
			while(_g2 < _g11) {
				var i1 = _g2++;
	...
	drawShape: function() {
		...
		if(this.isFondEmbedded) {
			...
			if(_this4._ctx != null) {
				...
				var tmp2 = "" + _this4._css + " " + _this4.get__size() + "px " + _this4._font;
				_this4._ctx.font = StringTools.ltrim(tmp2);
				...
				if(!isLines) {
					...
					var _g = 0;
					var _g1 = _this4._lineArray.length;
					while(_g < _g1) {
						var i = _g++;
				...
				var isLines1 = _this4.splitLines();
				var text1 = _this4._sketcher.makeText(_this4._text,_this4.get__x(),_this4.get__y());
				if(_this4.get__id() != null) {
					text1.set_id(_this4.get__id());
				}
				if(_this4._color != null) {
					text1.set_fill(cc_util_ColorUtil.getColourObj(_this4._color,_this4.get__alpha()));
				}
				text1.set_fontSize("" + _this4.get__size() + "px");
				text1.set_fontFamily("" + _this4._font);
				text1._textAlign = _this4._textAlign;
				text1._textBaseline = _this4._textBaseline;
				if(_this4.fontWeight != null) {
					text1.set_fontWeight("" + _this4._fontWeight);
				}
				_this4._hackText = text1;
			}
		}
	}
...
art_CC052.prototype = $extend(art_CCBase.prototype,{
	initSVG: function() {
		...
		this.svgImage.onload = function() {
			haxe_Log.trace("base64 square",{ fileName : "src/art/CC052.hx", lineNumber : 48, className : "art.CC052", methodName : "initSVG"});
			haxe_Log.trace("w: " + _gthis.svgImage.width,{ fileName : "src/art/CC052.hx", lineNumber : 49, className : "art.CC052", methodName : "initSVG"});
			haxe_Log.trace("h: " + _gthis.svgImage.height,{ fileName : "src/art/CC052.hx", lineNumber : 50, className : "art.CC052", methodName : "initSVG"});
	...
	,onEmbedHandler: function(e) {
		haxe_Log.trace("onEmbedHandler: \"" + e + "\"",{ fileName : "src/art/CC052.hx", lineNumber : 77, className : "art.CC052", methodName : "onEmbedHandler"});
		...
		while(_g < _g1) {
			...
			if(_this3._ctx != null) {
				...
				if(!isLines) {
					...
					var _g2 = 0;
					var _g11 = _this3._lineArray.length;
					while(_g2 < _g11) {
						var i1 = _g2++;
				...
				var isLines1 = _this3.splitLines();
				var text = _this3._sketcher.makeText(_this3._text,_this3.get__x(),_this3.get__y());
				if(_this3.get__id() != null) {
					text.set_id(_this3.get__id());
				}
				if(_this3._color != null) {
					text.set_fill(cc_util_ColorUtil.getColourObj(_this3._color,_this3.get__alpha()));
				}
				text.set_fontSize("" + _this3.get__size() + "px");
				text.set_fontFamily("" + _this3._font);
				text._textAlign = _this3._textAlign;
				text._textBaseline = _this3._textBaseline;
				if(_this3.fontWeight != null) {
					text.set_fontWeight("" + _this3._fontWeight);
				}
				_this3._hackText = text;
			}
		}
		this.stop();
	}
	,setup: function() {
		haxe_Log.trace("setup: " + this.toString(),{ fileName : "src/art/CC052.hx", lineNumber : 128, className : "art.CC052", methodName : "setup"});
		var colorArray = cc_util_ColorUtil.niceColor100SortedString[cc_util_MathUtil.randomInt(cc_util_ColorUtil.niceColor100SortedString.length - 1)];
		var int = Std.parseInt(StringTools.replace(colorArray[0],"#","0x"));
		this._color0 = { r : int >> 16 & 255, g : int >> 8 & 255, b : int & 255};
		var int1 = Std.parseInt(StringTools.replace(colorArray[1],"#","0x"));
	...
	,draw: function() {
		haxe_Log.trace("draw: " + this.toString(),{ fileName : "src/art/CC052.hx", lineNumber : 151, className : "art.CC052", methodName : "draw"});
		this.drawShape();
	}
	,didnotwork: function() {
		var _gthis = this;
		var img = new Image();
		img.onload = function() {
			haxe_Log.trace("green square",{ fileName : "src/art/CC052.hx", lineNumber : 162, className : "art.CC052", methodName : "didnotwork"});
			_gthis.ctx.drawImage(img,Global.w / 2,Global.h / 2);
		};
		img.src = "http://upload.wikimedia.org/wikipedia/commons/d/d2/Svg_example_square.svg";
		haxe_Log.trace(img.src,{ fileName : "src/art/CC052.hx", lineNumber : 168, className : "art.CC052", methodName : "didnotwork"});
		var img1 = new Image();
		img1.onload = function() {
			haxe_Log.trace("png",{ fileName : "src/art/CC052.hx", lineNumber : 172, className : "art.CC052", methodName : "didnotwork"});
			_gthis.ctx.drawImage(img1,Global.w / 2,Global.h / 2);
		};
		img1.src = "assets/img/mck.png";
		haxe_Log.trace(img1.src,{ fileName : "src/art/CC052.hx", lineNumber : 178, className : "art.CC052", methodName : "didnotwork"});
		var img2 = new Image();
		img2.onload = function() {
			haxe_Log.trace("likes",{ fileName : "src/art/CC052.hx", lineNumber : 182, className : "art.CC052", methodName : "didnotwork"});
			_gthis.ctx.drawImage(img2,Global.w / 2,Global.h / 2);
		};
		img2.src = "assets/img/likes/likes.svg";
		haxe_Log.trace(img2.src,{ fileName : "src/art/CC052.hx", lineNumber : 188, className : "art.CC052", methodName : "didnotwork"});
		var img3 = new Image();
		img3.onload = function() {
			haxe_Log.trace("likes.min",{ fileName : "src/art/CC052.hx", lineNumber : 192, className : "art.CC052", methodName : "didnotwork"});
			_gthis.ctx.drawImage(img3,Global.w / 2,Global.h / 2);
		};
		img3.src = "assets/img/likes/likes.min.svg";
		haxe_Log.trace(img3.src,{ fileName : "src/art/CC052.hx", lineNumber : 198, className : "art.CC052", methodName : "didnotwork"});
	}
	,__class__: art_CC052
});
...
art_CC052a.prototype = $extend(art_CCBase.prototype,{
	...
	,onAnimateHandler: function(sh) {
		...
		var _range1 = { key : "y", from : _this3._isFrom ? value1 : objValue1, to : !_this3._isFrom ? value1 : objValue1};
		var _this4 = _this3._props;
		if(__map_reserved["y"] != null) {
			_this4.setReserved("y",_range1);
		} else {
		...
		var _this5 = _this3;
		var objValue2 = 0;
		if(Object.prototype.hasOwnProperty.call(_this5._target,"alpha")) {
			objValue2 = Reflect.getProperty(_this5._target,"alpha");
		}
		var _range2 = { key : "alpha", from : _this5._isFrom ? 0 : objValue2, to : !_this5._isFrom ? 0 : objValue2};
		var _this6 = _this5._props;
		if(__map_reserved["alpha"] != null) {
			_this6.setReserved("alpha",_range2);
		} else {
			_this6.h["alpha"] = _range2;
		}
		if(_this5._isFrom) {
			_this5.updateProperties(0);
		}
		var _this7 = _this5;
		_this7._easing = cc_lets_easing_Sine.get_easeOut();
		var _this8 = _this7;
		_this8._options.onComplete = $bind(this,this.onAnimateHandler);
		_this8._options.onCompleteParams = [sh];
	}
	,drawShape: function() {
		if(!this.isSvgReady) {
			return;
	...
	,drawShape: function() {
		...
		if(_this5._ctx != null) {
			...
			if(!isLines) {
				...
				var _g = 0;
				var _g1 = _this5._lineArray.length;
				while(_g < _g1) {
					var i = _g++;
			...
			var isLines1 = _this5.splitLines();
			var text = _this5._sketcher.makeText(_this5._text,_this5.get__x(),_this5.get__y());
			if(_this5.get__id() != null) {
				text.set_id(_this5.get__id());
			}
			if(_this5._color != null) {
				text.set_fill(cc_util_ColorUtil.getColourObj(_this5._color,_this5.get__alpha()));
			}
			text.set_fontSize("" + _this5.get__size() + "px");
			text.set_fontFamily("" + _this5._font);
			text._textAlign = _this5._textAlign;
			text._textBaseline = _this5._textBaseline;
			if(_this5.fontWeight != null) {
				text.set_fontWeight("" + _this5._fontWeight);
			}
			_this5._hackText = text;
		}
		var Text2 = new cc_draw_Text(this.ctx,this.song);
		var _this7 = Text2;
		...
		if(_this12._ctx != null) {
			...
			var tmp3 = "" + _this12._css + " " + _this12.get__size() + "px " + _this12._font;
			_this12._ctx.font = StringTools.ltrim(tmp3);
			...
			if(!isLines2) {
				...
				var _g2 = 0;
				var _g11 = _this12._lineArray.length;
				while(_g2 < _g11) {
					var i1 = _g2++;
			...
			var isLines3 = _this12.splitLines();
			var text1 = _this12._sketcher.makeText(_this12._text,_this12.get__x(),_this12.get__y());
			if(_this12.get__id() != null) {
				text1.set_id(_this12.get__id());
			}
			if(_this12._color != null) {
				text1.set_fill(cc_util_ColorUtil.getColourObj(_this12._color,_this12.get__alpha()));
			}
			text1.set_fontSize("" + _this12.get__size() + "px");
			text1.set_fontFamily("" + _this12._font);
			text1._textAlign = _this12._textAlign;
			text1._textBaseline = _this12._textBaseline;
			if(_this12.fontWeight != null) {
				text1.set_fontWeight("" + _this12._fontWeight);
			}
			_this12._hackText = text1;
		}
...
art_CC054.prototype = $extend(art_CCBase.prototype,{
	...
	,createQuickSettings: function() {
		this.panel1 = QuickSettings.create(10,10,"Quote generator").setGlobalChangeHandler($bind(this,this.drawShape)).addHTML("Reason","Sometimes I need a quick quote, to post on Instagram").addTextArea("Quote","text",function(value) {
			...
			haxe_Log.trace(value1,{ fileName : "src/art/CC054.hx", lineNumber : 40, className : "art.CC054", methodName : "createQuickSettings"});
		}).saveInLocalStorage("store-data-" + this.toString());
	}
	,createShape: function(i,point) {
		var shape = { _id : "" + i, _type : "circle", x : point.x, y : point.y, radius : this._radius};
...
art_CC055.prototype = $extend(art_CCBase.prototype,{
	...
	,setDelay: function(e) {
		haxe_Log.trace(e,{ fileName : "src/art/CC055.hx", lineNumber : 71, className : "art.CC055", methodName : "setDelay"});
	}
	,setRecord: function(e) {
		haxe_Log.trace(e,{ fileName : "src/art/CC055.hx", lineNumber : 75, className : "art.CC055", methodName : "setRecord"});
	}
	,onClickHandler: function(e) {
		var input = e;
		switch(input.value) {
		case "init recording":
			haxe_Log.trace("init recording",{ fileName : "src/art/CC055.hx", lineNumber : 83, className : "art.CC055", methodName : "onClickHandler"});
			break;
		case "start recording":
			haxe_Log.trace("start recording",{ fileName : "src/art/CC055.hx", lineNumber : 85, className : "art.CC055", methodName : "onClickHandler"});
			break;
		case "stop recording":
			haxe_Log.trace("stop recording",{ fileName : "src/art/CC055.hx", lineNumber : 87, className : "art.CC055", methodName : "onClickHandler"});
			break;
		default:
			haxe_Log.trace("case '" + input.value + "': trace ('" + input.value + "');",{ fileName : "src/art/CC055.hx", lineNumber : 89, className : "art.CC055", methodName : "onClickHandler"});
		}
	}
	...
	,delayCallHandler: function() {
			...
			if(_this4._currentSprite > _this4._totalFrame) {
				if(_this4._isLoop) {
					if(_this4.get__isDebug()) {
						haxe_Log.trace("" + _this4.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this4._currentSprite = _this4.get__index();
				} else {
					if(_this4.get__isDebug()) {
						haxe_Log.trace("" + _this4.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					...
					var ypos1 = 0;
					if(_this4.get__isCentered()) {
						xpos1 = -Math.round(_this4.get__cellWidth() / 2);
						ypos1 = -Math.round(_this4.get__cellHeight() / 2);
					}
					_this4._ctx.save();
					_this4._ctx.translate(_this4.get__x(),_this4.get__y());
					_this4._ctx.rotate(cc_util_MathUtil.radians(_this4.get__rotate()));
					_this4._ctx.clearRect(xpos1 * _this4.get__scale(),ypos1 * _this4.get__scale(),_this4.get__cellWidth() * _this4.get__scale(),_this4.get__cellHeight() * _this4.get__scale());
					var shiftX1 = _this4._currentSprite * _this4.get__cellWidth();
					var shiftY1 = 0;
					_this4._ctx.scale(_this4.get__scale(),_this4.get__scale());
					_this4._ctx.drawImage(_this4.get__img(),shiftX1,shiftY1,_this4.get__cellWidth(),_this4.get__cellHeight(),xpos1,ypos1,_this4.get__cellWidth(),_this4.get__cellHeight());
					_this4._ctx.restore();
					if(_this4._isAnimation) {
						_this4._currentSprite++;
						if(_this4._currentSprite > _this4._totalFrame) {
		...
		_this5.set__cellWidth(100);
		_this5.set__cellHeight(100);
		_this5._totalFrame = Math.round(_this5.get__width() / _this5.get__cellWidth());
		var _this6 = _this5;
		_this6.set__x(110);
		_this6.set__y(0);
		var _this7 = _this6;
		_this7._isAnimation = true;
		_this7._isActive = true;
		var _this8 = _this7;
		_this8._delay = 60;
		var _this9 = _this8;
		if(_this9._isActive && _this9._pulse == null) {
			window.console.info("" + _this9.get__id() + " - this should happen only once! (" + _this9._pulse + " == null)");
			window.console.groupCollapsed("Spritesheet (" + _this9.get__id() + "):");
			window.console.warn("" + _this9.toString());
			window.console.groupEnd();
			_this9._pulse = window.requestAnimationFrame($bind(_this9,_this9.pulseHandler));
		}
		var xpos2 = 0;
		var ypos2 = 0;
		if(_this9.get__isCentered()) {
			xpos2 = -Math.round(_this9.get__cellWidth() / 2);
			ypos2 = -Math.round(_this9.get__cellHeight() / 2);
		}
		_this9._ctx.save();
		_this9._ctx.translate(_this9.get__x(),_this9.get__y());
		_this9._ctx.rotate(cc_util_MathUtil.radians(_this9.get__rotate()));
		_this9._ctx.clearRect(xpos2 * _this9.get__scale(),ypos2 * _this9.get__scale(),_this9.get__cellWidth() * _this9.get__scale(),_this9.get__cellHeight() * _this9.get__scale());
		var shiftX2 = _this9._currentSprite * _this9.get__cellWidth();
		var shiftY2 = 0;
		_this9._ctx.scale(_this9.get__scale(),_this9.get__scale());
		_this9._ctx.drawImage(_this9.get__img(),shiftX2,shiftY2,_this9.get__cellWidth(),_this9.get__cellHeight(),xpos2,ypos2,_this9.get__cellWidth(),_this9.get__cellHeight());
		_this9._ctx.restore();
		if(_this9._isAnimation) {
			_this9._currentSprite++;
			if(_this9._currentSprite > _this9._totalFrame) {
				if(_this9._isLoop) {
					if(_this9.get__isDebug()) {
						haxe_Log.trace("" + _this9.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this9._currentSprite = _this9.get__index();
				} else {
					if(_this9.get__isDebug()) {
						haxe_Log.trace("" + _this9.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this9._isAnimation = false;
					_this9._currentSprite = _this9._totalFrame - 1;
					if(_this9._isActive && _this9._pulse == null) {
						window.console.info("" + _this9.get__id() + " - this should happen only once! (" + _this9._pulse + " == null)");
						window.console.groupCollapsed("Spritesheet (" + _this9.get__id() + "):");
						window.console.warn("" + _this9.toString());
					...
					var ypos3 = 0;
					if(_this9.get__isCentered()) {
						xpos3 = -Math.round(_this9.get__cellWidth() / 2);
						ypos3 = -Math.round(_this9.get__cellHeight() / 2);
					}
					_this9._ctx.save();
					_this9._ctx.translate(_this9.get__x(),_this9.get__y());
					_this9._ctx.rotate(cc_util_MathUtil.radians(_this9.get__rotate()));
					_this9._ctx.clearRect(xpos3 * _this9.get__scale(),ypos3 * _this9.get__scale(),_this9.get__cellWidth() * _this9.get__scale(),_this9.get__cellHeight() * _this9.get__scale());
					var shiftX3 = _this9._currentSprite * _this9.get__cellWidth();
					var shiftY3 = 0;
					_this9._ctx.scale(_this9.get__scale(),_this9.get__scale());
					_this9._ctx.drawImage(_this9.get__img(),shiftX3,shiftY3,_this9.get__cellWidth(),_this9.get__cellHeight(),xpos3,ypos3,_this9.get__cellWidth(),_this9.get__cellHeight());
					_this9._ctx.restore();
					if(_this9._isAnimation) {
						_this9._currentSprite++;
						if(_this9._currentSprite > _this9._totalFrame) {
		...
		var _this10 = spritesheet2;
		_this10.set__cellWidth(100);
		_this10.set__cellHeight(100);
		_this10._totalFrame = Math.round(_this10.get__width() / _this10.get__cellWidth());
		var _this11 = _this10;
		_this11.set__x(220);
		_this11.set__y(0);
		var _this12 = _this11;
		_this12._isAnimation = true;
		_this12._isActive = true;
		var _this13 = _this12;
		_this13._delay = 120;
		var _this14 = _this13;
		if(_this14._isActive && _this14._pulse == null) {
			window.console.info("" + _this14.get__id() + " - this should happen only once! (" + _this14._pulse + " == null)");
			window.console.groupCollapsed("Spritesheet (" + _this14.get__id() + "):");
			window.console.warn("" + _this14.toString());
			window.console.groupEnd();
		...
		if(_this14.get__isCentered()) {
			xpos4 = -Math.round(_this14.get__cellWidth() / 2);
			ypos4 = -Math.round(_this14.get__cellHeight() / 2);
		}
		_this14._ctx.save();
		_this14._ctx.translate(_this14.get__x(),_this14.get__y());
		_this14._ctx.rotate(cc_util_MathUtil.radians(_this14.get__rotate()));
		_this14._ctx.clearRect(xpos4 * _this14.get__scale(),ypos4 * _this14.get__scale(),_this14.get__cellWidth() * _this14.get__scale(),_this14.get__cellHeight() * _this14.get__scale());
		var shiftX4 = _this14._currentSprite * _this14.get__cellWidth();
		var shiftY4 = 0;
		_this14._ctx.scale(_this14.get__scale(),_this14.get__scale());
		_this14._ctx.drawImage(_this14.get__img(),shiftX4,shiftY4,_this14.get__cellWidth(),_this14.get__cellHeight(),xpos4,ypos4,_this14.get__cellWidth(),_this14.get__cellHeight());
			...
			if(_this14._currentSprite > _this14._totalFrame) {
				if(_this14._isLoop) {
					if(_this14.get__isDebug()) {
						haxe_Log.trace("" + _this14.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this14._currentSprite = _this14.get__index();
				} else {
					if(_this14.get__isDebug()) {
						haxe_Log.trace("" + _this14.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					...
					var ypos5 = 0;
					if(_this14.get__isCentered()) {
						xpos5 = -Math.round(_this14.get__cellWidth() / 2);
						ypos5 = -Math.round(_this14.get__cellHeight() / 2);
					}
					_this14._ctx.save();
					_this14._ctx.translate(_this14.get__x(),_this14.get__y());
					_this14._ctx.rotate(cc_util_MathUtil.radians(_this14.get__rotate()));
					_this14._ctx.clearRect(xpos5 * _this14.get__scale(),ypos5 * _this14.get__scale(),_this14.get__cellWidth() * _this14.get__scale(),_this14.get__cellHeight() * _this14.get__scale());
					var shiftX5 = _this14._currentSprite * _this14.get__cellWidth();
					var shiftY5 = 0;
					_this14._ctx.scale(_this14.get__scale(),_this14.get__scale());
					_this14._ctx.drawImage(_this14.get__img(),shiftX5,shiftY5,_this14.get__cellWidth(),_this14.get__cellHeight(),xpos5,ypos5,_this14.get__cellWidth(),_this14.get__cellHeight());
					_this14._ctx.restore();
					if(_this14._isAnimation) {
						_this14._currentSprite++;
						if(_this14._currentSprite > _this14._totalFrame) {
		...
		var _this15 = spritesheet3;
		_this15.set__cellWidth(100);
		_this15.set__cellHeight(100);
		_this15._totalFrame = Math.round(_this15.get__width() / _this15.get__cellWidth());
		var _this16 = _this15;
		_this16.set__x(330);
		_this16.set__y(0);
		var _this17 = _this16;
		...
		_this18._delay = 180;
		var _this19 = _this18;
		if(_this19._isActive && _this19._pulse == null) {
			window.console.info("" + _this19.get__id() + " - this should happen only once! (" + _this19._pulse + " == null)");
			window.console.groupCollapsed("Spritesheet (" + _this19.get__id() + "):");
			window.console.warn("" + _this19.toString());
			window.console.groupEnd();
			_this19._pulse = window.requestAnimationFrame($bind(_this19,_this19.pulseHandler));
		}
		var xpos6 = 0;
		var ypos6 = 0;
		if(_this19.get__isCentered()) {
			xpos6 = -Math.round(_this19.get__cellWidth() / 2);
			ypos6 = -Math.round(_this19.get__cellHeight() / 2);
		}
		_this19._ctx.save();
		_this19._ctx.translate(_this19.get__x(),_this19.get__y());
		_this19._ctx.rotate(cc_util_MathUtil.radians(_this19.get__rotate()));
		_this19._ctx.clearRect(xpos6 * _this19.get__scale(),ypos6 * _this19.get__scale(),_this19.get__cellWidth() * _this19.get__scale(),_this19.get__cellHeight() * _this19.get__scale());
		var shiftX6 = _this19._currentSprite * _this19.get__cellWidth();
		var shiftY6 = 0;
		_this19._ctx.scale(_this19.get__scale(),_this19.get__scale());
		_this19._ctx.drawImage(_this19.get__img(),shiftX6,shiftY6,_this19.get__cellWidth(),_this19.get__cellHeight(),xpos6,ypos6,_this19.get__cellWidth(),_this19.get__cellHeight());
		_this19._ctx.restore();
		if(_this19._isAnimation) {
			_this19._currentSprite++;
			if(_this19._currentSprite > _this19._totalFrame) {
				if(_this19._isLoop) {
					if(_this19.get__isDebug()) {
						haxe_Log.trace("" + _this19.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this19._currentSprite = _this19.get__index();
				} else {
					if(_this19.get__isDebug()) {
						haxe_Log.trace("" + _this19.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this19._isAnimation = false;
					_this19._currentSprite = _this19._totalFrame - 1;
					if(_this19._isActive && _this19._pulse == null) {
						window.console.info("" + _this19.get__id() + " - this should happen only once! (" + _this19._pulse + " == null)");
						window.console.groupCollapsed("Spritesheet (" + _this19.get__id() + "):");
						window.console.warn("" + _this19.toString());
					...
					var ypos7 = 0;
					if(_this19.get__isCentered()) {
						xpos7 = -Math.round(_this19.get__cellWidth() / 2);
						ypos7 = -Math.round(_this19.get__cellHeight() / 2);
					}
					_this19._ctx.save();
					_this19._ctx.translate(_this19.get__x(),_this19.get__y());
					_this19._ctx.rotate(cc_util_MathUtil.radians(_this19.get__rotate()));
					_this19._ctx.clearRect(xpos7 * _this19.get__scale(),ypos7 * _this19.get__scale(),_this19.get__cellWidth() * _this19.get__scale(),_this19.get__cellHeight() * _this19.get__scale());
					var shiftX7 = _this19._currentSprite * _this19.get__cellWidth();
					var shiftY7 = 0;
					_this19._ctx.scale(_this19.get__scale(),_this19.get__scale());
					_this19._ctx.drawImage(_this19.get__img(),shiftX7,shiftY7,_this19.get__cellWidth(),_this19.get__cellHeight(),xpos7,ypos7,_this19.get__cellWidth(),_this19.get__cellHeight());
					_this19._ctx.restore();
					if(_this19._isAnimation) {
						_this19._currentSprite++;
						if(_this19._currentSprite > _this19._totalFrame) {
		...
		var _this20 = spritesheet4;
		_this20.set__cellWidth(100);
		_this20.set__cellHeight(100);
		_this20._totalFrame = Math.round(_this20.get__width() / _this20.get__cellWidth());
		var _this21 = _this20;
		_this21.set__x(440);
		_this21.set__y(0);
		var _this22 = _this21;
		_this22._isAnimation = true;
		_this22._isActive = true;
		var _this23 = _this22;
		_this23._delay = 240;
		var _this24 = _this23;
		if(_this24._isActive && _this24._pulse == null) {
			window.console.info("" + _this24.get__id() + " - this should happen only once! (" + _this24._pulse + " == null)");
			window.console.groupCollapsed("Spritesheet (" + _this24.get__id() + "):");
			window.console.warn("" + _this24.toString());
			window.console.groupEnd();
			_this24._pulse = window.requestAnimationFrame($bind(_this24,_this24.pulseHandler));
		}
		var xpos8 = 0;
		var ypos8 = 0;
		if(_this24.get__isCentered()) {
			xpos8 = -Math.round(_this24.get__cellWidth() / 2);
			ypos8 = -Math.round(_this24.get__cellHeight() / 2);
		}
		_this24._ctx.save();
		_this24._ctx.translate(_this24.get__x(),_this24.get__y());
		_this24._ctx.rotate(cc_util_MathUtil.radians(_this24.get__rotate()));
		_this24._ctx.clearRect(xpos8 * _this24.get__scale(),ypos8 * _this24.get__scale(),_this24.get__cellWidth() * _this24.get__scale(),_this24.get__cellHeight() * _this24.get__scale());
		var shiftX8 = _this24._currentSprite * _this24.get__cellWidth();
		var shiftY8 = 0;
		_this24._ctx.scale(_this24.get__scale(),_this24.get__scale());
		_this24._ctx.drawImage(_this24.get__img(),shiftX8,shiftY8,_this24.get__cellWidth(),_this24.get__cellHeight(),xpos8,ypos8,_this24.get__cellWidth(),_this24.get__cellHeight());
		_this24._ctx.restore();
		if(_this24._isAnimation) {
			_this24._currentSprite++;
			if(_this24._currentSprite > _this24._totalFrame) {
				if(_this24._isLoop) {
					if(_this24.get__isDebug()) {
						haxe_Log.trace("" + _this24.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this24._currentSprite = _this24.get__index();
				} else {
					if(_this24.get__isDebug()) {
						haxe_Log.trace("" + _this24.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this24._isAnimation = false;
					_this24._currentSprite = _this24._totalFrame - 1;
					if(_this24._isActive && _this24._pulse == null) {
						window.console.info("" + _this24.get__id() + " - this should happen only once! (" + _this24._pulse + " == null)");
						window.console.groupCollapsed("Spritesheet (" + _this24.get__id() + "):");
						window.console.warn("" + _this24.toString());
					...
					var ypos9 = 0;
					if(_this24.get__isCentered()) {
						xpos9 = -Math.round(_this24.get__cellWidth() / 2);
						ypos9 = -Math.round(_this24.get__cellHeight() / 2);
					}
					_this24._ctx.save();
					_this24._ctx.translate(_this24.get__x(),_this24.get__y());
					_this24._ctx.rotate(cc_util_MathUtil.radians(_this24.get__rotate()));
					_this24._ctx.clearRect(xpos9 * _this24.get__scale(),ypos9 * _this24.get__scale(),_this24.get__cellWidth() * _this24.get__scale(),_this24.get__cellHeight() * _this24.get__scale());
					var shiftX9 = _this24._currentSprite * _this24.get__cellWidth();
					var shiftY9 = 0;
					_this24._ctx.scale(_this24.get__scale(),_this24.get__scale());
					_this24._ctx.drawImage(_this24.get__img(),shiftX9,shiftY9,_this24.get__cellWidth(),_this24.get__cellHeight(),xpos9,ypos9,_this24.get__cellWidth(),_this24.get__cellHeight());
					_this24._ctx.restore();
					if(_this24._isAnimation) {
						_this24._currentSprite++;
						if(_this24._currentSprite > _this24._totalFrame) {
		...
		var spritesheet5 = new cc_draw_Spritesheet(this.ctx,this._img);
		var _this25 = spritesheet5;
		_this25.set__cellWidth(100);
		_this25.set__cellHeight(100);
		_this25._totalFrame = Math.round(_this25.get__width() / _this25.get__cellWidth());
		var _this26 = _this25;
		_this26.set__x(550);
		_this26.set__y(0);
		var _this27 = _this26;
		_this27._isAnimation = true;
		_this27._isActive = true;
		var _this28 = _this27;
		_this28._delay = 300;
		var _this29 = _this28;
		if(_this29._isActive && _this29._pulse == null) {
			window.console.info("" + _this29.get__id() + " - this should happen only once! (" + _this29._pulse + " == null)");
			window.console.groupCollapsed("Spritesheet (" + _this29.get__id() + "):");
			window.console.warn("" + _this29.toString());
			window.console.groupEnd();
			_this29._pulse = window.requestAnimationFrame($bind(_this29,_this29.pulseHandler));
		}
		var xpos10 = 0;
		var ypos10 = 0;
		if(_this29.get__isCentered()) {
			xpos10 = -Math.round(_this29.get__cellWidth() / 2);
			ypos10 = -Math.round(_this29.get__cellHeight() / 2);
		}
		_this29._ctx.save();
		_this29._ctx.translate(_this29.get__x(),_this29.get__y());
		_this29._ctx.rotate(cc_util_MathUtil.radians(_this29.get__rotate()));
		_this29._ctx.clearRect(xpos10 * _this29.get__scale(),ypos10 * _this29.get__scale(),_this29.get__cellWidth() * _this29.get__scale(),_this29.get__cellHeight() * _this29.get__scale());
		var shiftX10 = _this29._currentSprite * _this29.get__cellWidth();
		var shiftY10 = 0;
		_this29._ctx.scale(_this29.get__scale(),_this29.get__scale());
		_this29._ctx.drawImage(_this29.get__img(),shiftX10,shiftY10,_this29.get__cellWidth(),_this29.get__cellHeight(),xpos10,ypos10,_this29.get__cellWidth(),_this29.get__cellHeight());
		_this29._ctx.restore();
		if(_this29._isAnimation) {
			_this29._currentSprite++;
			if(_this29._currentSprite > _this29._totalFrame) {
				if(_this29._isLoop) {
					if(_this29.get__isDebug()) {
						haxe_Log.trace("" + _this29.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this29._currentSprite = _this29.get__index();
				} else {
					if(_this29.get__isDebug()) {
						haxe_Log.trace("" + _this29.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this29._isAnimation = false;
					_this29._currentSprite = _this29._totalFrame - 1;
					if(_this29._isActive && _this29._pulse == null) {
						window.console.info("" + _this29.get__id() + " - this should happen only once! (" + _this29._pulse + " == null)");
						window.console.groupCollapsed("Spritesheet (" + _this29.get__id() + "):");
						window.console.warn("" + _this29.toString());
					...
					var ypos11 = 0;
					if(_this29.get__isCentered()) {
						xpos11 = -Math.round(_this29.get__cellWidth() / 2);
						ypos11 = -Math.round(_this29.get__cellHeight() / 2);
					}
					_this29._ctx.save();
					_this29._ctx.translate(_this29.get__x(),_this29.get__y());
					_this29._ctx.rotate(cc_util_MathUtil.radians(_this29.get__rotate()));
					_this29._ctx.clearRect(xpos11 * _this29.get__scale(),ypos11 * _this29.get__scale(),_this29.get__cellWidth() * _this29.get__scale(),_this29.get__cellHeight() * _this29.get__scale());
					var shiftX11 = _this29._currentSprite * _this29.get__cellWidth();
					var shiftY11 = 0;
					_this29._ctx.scale(_this29.get__scale(),_this29.get__scale());
					_this29._ctx.drawImage(_this29.get__img(),shiftX11,shiftY11,_this29.get__cellWidth(),_this29.get__cellHeight(),xpos11,ypos11,_this29.get__cellWidth(),_this29.get__cellHeight());
					_this29._ctx.restore();
					if(_this29._isAnimation) {
						_this29._currentSprite++;
						if(_this29._currentSprite > _this29._totalFrame) {
		...
		var spritesheet6 = new cc_draw_Spritesheet(this.ctx,this._img);
		var _this30 = spritesheet6;
		_this30.set__cellWidth(100);
		_this30.set__cellHeight(100);
		_this30._totalFrame = Math.round(_this30.get__width() / _this30.get__cellWidth());
		var _this31 = _this30;
		_this31.set__x(660);
		_this31.set__y(0);
		var _this32 = _this31;
		_this32._isAnimation = true;
		_this32._isActive = true;
		var _this33 = _this32;
		_this33._delay = 360;
		var _this34 = _this33;
		...
		if(_this34.get__isCentered()) {
			xpos12 = -Math.round(_this34.get__cellWidth() / 2);
			ypos12 = -Math.round(_this34.get__cellHeight() / 2);
		}
		_this34._ctx.save();
		_this34._ctx.translate(_this34.get__x(),_this34.get__y());
		_this34._ctx.rotate(cc_util_MathUtil.radians(_this34.get__rotate()));
		_this34._ctx.clearRect(xpos12 * _this34.get__scale(),ypos12 * _this34.get__scale(),_this34.get__cellWidth() * _this34.get__scale(),_this34.get__cellHeight() * _this34.get__scale());
		var shiftX12 = _this34._currentSprite * _this34.get__cellWidth();
		var shiftY12 = 0;
		_this34._ctx.scale(_this34.get__scale(),_this34.get__scale());
		_this34._ctx.drawImage(_this34.get__img(),shiftX12,shiftY12,_this34.get__cellWidth(),_this34.get__cellHeight(),xpos12,ypos12,_this34.get__cellWidth(),_this34.get__cellHeight());
			...
			if(_this34._currentSprite > _this34._totalFrame) {
				if(_this34._isLoop) {
					if(_this34.get__isDebug()) {
						haxe_Log.trace("" + _this34.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this34._currentSprite = _this34.get__index();
				} else {
					if(_this34.get__isDebug()) {
						haxe_Log.trace("" + _this34.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					...
					var ypos13 = 0;
					if(_this34.get__isCentered()) {
						xpos13 = -Math.round(_this34.get__cellWidth() / 2);
						ypos13 = -Math.round(_this34.get__cellHeight() / 2);
					}
					_this34._ctx.save();
					_this34._ctx.translate(_this34.get__x(),_this34.get__y());
					_this34._ctx.rotate(cc_util_MathUtil.radians(_this34.get__rotate()));
					_this34._ctx.clearRect(xpos13 * _this34.get__scale(),ypos13 * _this34.get__scale(),_this34.get__cellWidth() * _this34.get__scale(),_this34.get__cellHeight() * _this34.get__scale());
					var shiftX13 = _this34._currentSprite * _this34.get__cellWidth();
					var shiftY13 = 0;
					_this34._ctx.scale(_this34.get__scale(),_this34.get__scale());
					_this34._ctx.drawImage(_this34.get__img(),shiftX13,shiftY13,_this34.get__cellWidth(),_this34.get__cellHeight(),xpos13,ypos13,_this34.get__cellWidth(),_this34.get__cellHeight());
					_this34._ctx.restore();
					if(_this34._isAnimation) {
						_this34._currentSprite++;
						if(_this34._currentSprite > _this34._totalFrame) {
		...
		var spritesheet7 = new cc_draw_Spritesheet(this.ctx,this._img);
		var _this35 = spritesheet7;
		_this35.set__cellWidth(100);
		_this35.set__cellHeight(100);
		_this35._totalFrame = Math.round(_this35.get__width() / _this35.get__cellWidth());
		var _this36 = _this35;
		_this36.set__x(770);
		_this36.set__y(0);
		var _this37 = _this36;
		_this37._isAnimation = true;
		_this37._isActive = true;
		var _this38 = _this37;
		_this38._delay = 420;
		var _this39 = _this38;
		if(_this39._isActive && _this39._pulse == null) {
			window.console.info("" + _this39.get__id() + " - this should happen only once! (" + _this39._pulse + " == null)");
			window.console.groupCollapsed("Spritesheet (" + _this39.get__id() + "):");
			window.console.warn("" + _this39.toString());
			window.console.groupEnd();
			_this39._pulse = window.requestAnimationFrame($bind(_this39,_this39.pulseHandler));
		}
		var xpos14 = 0;
		var ypos14 = 0;
		if(_this39.get__isCentered()) {
			xpos14 = -Math.round(_this39.get__cellWidth() / 2);
			ypos14 = -Math.round(_this39.get__cellHeight() / 2);
		}
		_this39._ctx.save();
		_this39._ctx.translate(_this39.get__x(),_this39.get__y());
		_this39._ctx.rotate(cc_util_MathUtil.radians(_this39.get__rotate()));
		_this39._ctx.clearRect(xpos14 * _this39.get__scale(),ypos14 * _this39.get__scale(),_this39.get__cellWidth() * _this39.get__scale(),_this39.get__cellHeight() * _this39.get__scale());
		var shiftX14 = _this39._currentSprite * _this39.get__cellWidth();
		var shiftY14 = 0;
		_this39._ctx.scale(_this39.get__scale(),_this39.get__scale());
		_this39._ctx.drawImage(_this39.get__img(),shiftX14,shiftY14,_this39.get__cellWidth(),_this39.get__cellHeight(),xpos14,ypos14,_this39.get__cellWidth(),_this39.get__cellHeight());
		_this39._ctx.restore();
		if(_this39._isAnimation) {
			_this39._currentSprite++;
			if(_this39._currentSprite > _this39._totalFrame) {
				if(_this39._isLoop) {
					if(_this39.get__isDebug()) {
						haxe_Log.trace("" + _this39.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this39._currentSprite = _this39.get__index();
				} else {
					if(_this39.get__isDebug()) {
						haxe_Log.trace("" + _this39.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this39._isAnimation = false;
					_this39._currentSprite = _this39._totalFrame - 1;
					if(_this39._isActive && _this39._pulse == null) {
						window.console.info("" + _this39.get__id() + " - this should happen only once! (" + _this39._pulse + " == null)");
						window.console.groupCollapsed("Spritesheet (" + _this39.get__id() + "):");
						window.console.warn("" + _this39.toString());
					...
					var ypos15 = 0;
					if(_this39.get__isCentered()) {
						xpos15 = -Math.round(_this39.get__cellWidth() / 2);
						ypos15 = -Math.round(_this39.get__cellHeight() / 2);
					}
					_this39._ctx.save();
					_this39._ctx.translate(_this39.get__x(),_this39.get__y());
					_this39._ctx.rotate(cc_util_MathUtil.radians(_this39.get__rotate()));
					_this39._ctx.clearRect(xpos15 * _this39.get__scale(),ypos15 * _this39.get__scale(),_this39.get__cellWidth() * _this39.get__scale(),_this39.get__cellHeight() * _this39.get__scale());
					var shiftX15 = _this39._currentSprite * _this39.get__cellWidth();
					var shiftY15 = 0;
					_this39._ctx.scale(_this39.get__scale(),_this39.get__scale());
					_this39._ctx.drawImage(_this39.get__img(),shiftX15,shiftY15,_this39.get__cellWidth(),_this39.get__cellHeight(),xpos15,ypos15,_this39.get__cellWidth(),_this39.get__cellHeight());
					_this39._ctx.restore();
					if(_this39._isAnimation) {
						_this39._currentSprite++;
						if(_this39._currentSprite > _this39._totalFrame) {
		...
		var spritesheet8 = new cc_draw_Spritesheet(this.ctx,this._img);
		var _this40 = spritesheet8;
		_this40.set__cellWidth(100);
		_this40.set__cellHeight(100);
		_this40._totalFrame = Math.round(_this40.get__width() / _this40.get__cellWidth());
		var _this41 = _this40;
		_this41.set__x(880);
		_this41.set__y(0);
		var _this42 = _this41;
		_this42._isAnimation = true;
		_this42._isActive = true;
		var _this43 = _this42;
		_this43._delay = 480;
		var _this44 = _this43;
		if(_this44._isActive && _this44._pulse == null) {
			window.console.info("" + _this44.get__id() + " - this should happen only once! (" + _this44._pulse + " == null)");
			window.console.groupCollapsed("Spritesheet (" + _this44.get__id() + "):");
			window.console.warn("" + _this44.toString());
			window.console.groupEnd();
			_this44._pulse = window.requestAnimationFrame($bind(_this44,_this44.pulseHandler));
		}
		var xpos16 = 0;
		var ypos16 = 0;
		if(_this44.get__isCentered()) {
			xpos16 = -Math.round(_this44.get__cellWidth() / 2);
			ypos16 = -Math.round(_this44.get__cellHeight() / 2);
		}
		_this44._ctx.save();
		_this44._ctx.translate(_this44.get__x(),_this44.get__y());
		_this44._ctx.rotate(cc_util_MathUtil.radians(_this44.get__rotate()));
		_this44._ctx.clearRect(xpos16 * _this44.get__scale(),ypos16 * _this44.get__scale(),_this44.get__cellWidth() * _this44.get__scale(),_this44.get__cellHeight() * _this44.get__scale());
		var shiftX16 = _this44._currentSprite * _this44.get__cellWidth();
		var shiftY16 = 0;
		_this44._ctx.scale(_this44.get__scale(),_this44.get__scale());
		_this44._ctx.drawImage(_this44.get__img(),shiftX16,shiftY16,_this44.get__cellWidth(),_this44.get__cellHeight(),xpos16,ypos16,_this44.get__cellWidth(),_this44.get__cellHeight());
		_this44._ctx.restore();
		if(_this44._isAnimation) {
			_this44._currentSprite++;
			if(_this44._currentSprite > _this44._totalFrame) {
				if(_this44._isLoop) {
					if(_this44.get__isDebug()) {
						haxe_Log.trace("" + _this44.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this44._currentSprite = _this44.get__index();
				} else {
					if(_this44.get__isDebug()) {
						haxe_Log.trace("" + _this44.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this44._isAnimation = false;
					_this44._currentSprite = _this44._totalFrame - 1;
					if(_this44._isActive && _this44._pulse == null) {
						window.console.info("" + _this44.get__id() + " - this should happen only once! (" + _this44._pulse + " == null)");
						window.console.groupCollapsed("Spritesheet (" + _this44.get__id() + "):");
						window.console.warn("" + _this44.toString());
					...
					var ypos17 = 0;
					if(_this44.get__isCentered()) {
						xpos17 = -Math.round(_this44.get__cellWidth() / 2);
						ypos17 = -Math.round(_this44.get__cellHeight() / 2);
					}
					_this44._ctx.save();
					_this44._ctx.translate(_this44.get__x(),_this44.get__y());
					_this44._ctx.rotate(cc_util_MathUtil.radians(_this44.get__rotate()));
					_this44._ctx.clearRect(xpos17 * _this44.get__scale(),ypos17 * _this44.get__scale(),_this44.get__cellWidth() * _this44.get__scale(),_this44.get__cellHeight() * _this44.get__scale());
					var shiftX17 = _this44._currentSprite * _this44.get__cellWidth();
					var shiftY17 = 0;
					_this44._ctx.scale(_this44.get__scale(),_this44.get__scale());
					_this44._ctx.drawImage(_this44.get__img(),shiftX17,shiftY17,_this44.get__cellWidth(),_this44.get__cellHeight(),xpos17,ypos17,_this44.get__cellWidth(),_this44.get__cellHeight());
					_this44._ctx.restore();
					if(_this44._isAnimation) {
						_this44._currentSprite++;
						if(_this44._currentSprite > _this44._totalFrame) {
		...
		var spritesheet9 = new cc_draw_Spritesheet(this.ctx,this._img);
		var _this45 = spritesheet9;
		_this45.set__cellWidth(100);
		_this45.set__cellHeight(100);
		_this45._totalFrame = Math.round(_this45.get__width() / _this45.get__cellWidth());
		var _this46 = _this45;
		_this46.set__x(990);
		_this46.set__y(0);
		var _this47 = _this46;
		_this47._isAnimation = true;
		_this47._isActive = true;
		var _this48 = _this47;
		_this48._delay = 540;
		var _this49 = _this48;
		if(_this49._isActive && _this49._pulse == null) {
			window.console.info("" + _this49.get__id() + " - this should happen only once! (" + _this49._pulse + " == null)");
			window.console.groupCollapsed("Spritesheet (" + _this49.get__id() + "):");
			window.console.warn("" + _this49.toString());
			window.console.groupEnd();
			_this49._pulse = window.requestAnimationFrame($bind(_this49,_this49.pulseHandler));
		}
		var xpos18 = 0;
		var ypos18 = 0;
		if(_this49.get__isCentered()) {
			xpos18 = -Math.round(_this49.get__cellWidth() / 2);
			ypos18 = -Math.round(_this49.get__cellHeight() / 2);
		}
		_this49._ctx.save();
		_this49._ctx.translate(_this49.get__x(),_this49.get__y());
		_this49._ctx.rotate(cc_util_MathUtil.radians(_this49.get__rotate()));
		_this49._ctx.clearRect(xpos18 * _this49.get__scale(),ypos18 * _this49.get__scale(),_this49.get__cellWidth() * _this49.get__scale(),_this49.get__cellHeight() * _this49.get__scale());
		var shiftX18 = _this49._currentSprite * _this49.get__cellWidth();
		var shiftY18 = 0;
		_this49._ctx.scale(_this49.get__scale(),_this49.get__scale());
		_this49._ctx.drawImage(_this49.get__img(),shiftX18,shiftY18,_this49.get__cellWidth(),_this49.get__cellHeight(),xpos18,ypos18,_this49.get__cellWidth(),_this49.get__cellHeight());
		_this49._ctx.restore();
		if(_this49._isAnimation) {
			_this49._currentSprite++;
			if(_this49._currentSprite > _this49._totalFrame) {
				if(_this49._isLoop) {
					if(_this49.get__isDebug()) {
						haxe_Log.trace("" + _this49.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this49._currentSprite = _this49.get__index();
				} else {
					if(_this49.get__isDebug()) {
						haxe_Log.trace("" + _this49.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this49._isAnimation = false;
					_this49._currentSprite = _this49._totalFrame - 1;
					if(_this49._isActive && _this49._pulse == null) {
						window.console.info("" + _this49.get__id() + " - this should happen only once! (" + _this49._pulse + " == null)");
						window.console.groupCollapsed("Spritesheet (" + _this49.get__id() + "):");
						window.console.warn("" + _this49.toString());
					...
					var ypos19 = 0;
					if(_this49.get__isCentered()) {
						xpos19 = -Math.round(_this49.get__cellWidth() / 2);
						ypos19 = -Math.round(_this49.get__cellHeight() / 2);
					}
					_this49._ctx.save();
					_this49._ctx.translate(_this49.get__x(),_this49.get__y());
					_this49._ctx.rotate(cc_util_MathUtil.radians(_this49.get__rotate()));
					_this49._ctx.clearRect(xpos19 * _this49.get__scale(),ypos19 * _this49.get__scale(),_this49.get__cellWidth() * _this49.get__scale(),_this49.get__cellHeight() * _this49.get__scale());
					var shiftX19 = _this49._currentSprite * _this49.get__cellWidth();
					var shiftY19 = 0;
					_this49._ctx.scale(_this49.get__scale(),_this49.get__scale());
					_this49._ctx.drawImage(_this49.get__img(),shiftX19,shiftY19,_this49.get__cellWidth(),_this49.get__cellHeight(),xpos19,ypos19,_this49.get__cellWidth(),_this49.get__cellHeight());
					_this49._ctx.restore();
					if(_this49._isAnimation) {
						_this49._currentSprite++;
						if(_this49._currentSprite > _this49._totalFrame) {
		...
		var _scale = 4;
		var spritesheet10 = new cc_draw_Spritesheet(this.ctx,this._img);
		var _this50 = spritesheet10;
		_this50.set__isDebug(this.isDebug);
		var _this51 = _this50;
		_this51.set__fps(5);
		var _this52 = _this51;
		_this52.set__cellWidth(100);
		_this52.set__cellHeight(100);
		_this52._totalFrame = Math.round(_this52.get__width() / _this52.get__cellWidth());
		var _this53 = _this52;
		_this53.set__scale(_scale);
		var _this54 = _this53;
		_this54.set__x(Global.w - 100 * _scale);
		_this54.set__y(0);
		var _this55 = _this54;
		_this55._isAnimation = true;
		_this55._isActive = true;
		var _this56 = _this55;
		if(_this56._isActive && _this56._pulse == null) {
			window.console.info("" + _this56.get__id() + " - this should happen only once! (" + _this56._pulse + " == null)");
			window.console.groupCollapsed("Spritesheet (" + _this56.get__id() + "):");
			window.console.warn("" + _this56.toString());
			window.console.groupEnd();
			_this56._pulse = window.requestAnimationFrame($bind(_this56,_this56.pulseHandler));
		}
		var xpos20 = 0;
		var ypos20 = 0;
		if(_this56.get__isCentered()) {
			xpos20 = -Math.round(_this56.get__cellWidth() / 2);
			ypos20 = -Math.round(_this56.get__cellHeight() / 2);
		}
		_this56._ctx.save();
		_this56._ctx.translate(_this56.get__x(),_this56.get__y());
		_this56._ctx.rotate(cc_util_MathUtil.radians(_this56.get__rotate()));
		_this56._ctx.clearRect(xpos20 * _this56.get__scale(),ypos20 * _this56.get__scale(),_this56.get__cellWidth() * _this56.get__scale(),_this56.get__cellHeight() * _this56.get__scale());
		var shiftX20 = _this56._currentSprite * _this56.get__cellWidth();
		var shiftY20 = 0;
		_this56._ctx.scale(_this56.get__scale(),_this56.get__scale());
		_this56._ctx.drawImage(_this56.get__img(),shiftX20,shiftY20,_this56.get__cellWidth(),_this56.get__cellHeight(),xpos20,ypos20,_this56.get__cellWidth(),_this56.get__cellHeight());
		_this56._ctx.restore();
		if(_this56._isAnimation) {
			_this56._currentSprite++;
			if(_this56._currentSprite > _this56._totalFrame) {
				if(_this56._isLoop) {
					if(_this56.get__isDebug()) {
						haxe_Log.trace("" + _this56.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this56._currentSprite = _this56.get__index();
				} else {
					if(_this56.get__isDebug()) {
						haxe_Log.trace("" + _this56.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this56._isAnimation = false;
					_this56._currentSprite = _this56._totalFrame - 1;
					if(_this56._isActive && _this56._pulse == null) {
						window.console.info("" + _this56.get__id() + " - this should happen only once! (" + _this56._pulse + " == null)");
						window.console.groupCollapsed("Spritesheet (" + _this56.get__id() + "):");
						window.console.warn("" + _this56.toString());
					...
					var ypos21 = 0;
					if(_this56.get__isCentered()) {
						xpos21 = -Math.round(_this56.get__cellWidth() / 2);
						ypos21 = -Math.round(_this56.get__cellHeight() / 2);
					}
					_this56._ctx.save();
					_this56._ctx.translate(_this56.get__x(),_this56.get__y());
					_this56._ctx.rotate(cc_util_MathUtil.radians(_this56.get__rotate()));
					_this56._ctx.clearRect(xpos21 * _this56.get__scale(),ypos21 * _this56.get__scale(),_this56.get__cellWidth() * _this56.get__scale(),_this56.get__cellHeight() * _this56.get__scale());
					var shiftX21 = _this56._currentSprite * _this56.get__cellWidth();
					var shiftY21 = 0;
					_this56._ctx.scale(_this56.get__scale(),_this56.get__scale());
					_this56._ctx.drawImage(_this56.get__img(),shiftX21,shiftY21,_this56.get__cellWidth(),_this56.get__cellHeight(),xpos21,ypos21,_this56.get__cellWidth(),_this56.get__cellHeight());
					_this56._ctx.restore();
					if(_this56._isAnimation) {
						_this56._currentSprite++;
						if(_this56._currentSprite > _this56._totalFrame) {
		...
		var spritesheet11 = new cc_draw_Spritesheet(this.ctx,this._img);
		var _this57 = spritesheet11;
		_this57.set__isDebug(this.isDebug);
		var _this58 = _this57;
		_this58.set__fps(15);
		var _this59 = _this58;
		_this59.set__cellWidth(100);
		_this59.set__cellHeight(100);
		_this59._totalFrame = Math.round(_this59.get__width() / _this59.get__cellWidth());
		var _this60 = _this59;
		_this60.set__scale(_scale);
		var _this61 = _this60;
		var y = Global.h - 100 * _scale;
		_this61.set__x(0);
		_this61.set__y(y);
		var _this62 = _this61;
		_this62._isAnimation = true;
		_this62._isActive = true;
		var _this63 = _this62;
		if(_this63._isActive && _this63._pulse == null) {
			window.console.info("" + _this63.get__id() + " - this should happen only once! (" + _this63._pulse + " == null)");
			window.console.groupCollapsed("Spritesheet (" + _this63.get__id() + "):");
			window.console.warn("" + _this63.toString());
			window.console.groupEnd();
			_this63._pulse = window.requestAnimationFrame($bind(_this63,_this63.pulseHandler));
		}
		var xpos22 = 0;
		var ypos22 = 0;
		if(_this63.get__isCentered()) {
			xpos22 = -Math.round(_this63.get__cellWidth() / 2);
			ypos22 = -Math.round(_this63.get__cellHeight() / 2);
		}
		_this63._ctx.save();
		_this63._ctx.translate(_this63.get__x(),_this63.get__y());
		_this63._ctx.rotate(cc_util_MathUtil.radians(_this63.get__rotate()));
		_this63._ctx.clearRect(xpos22 * _this63.get__scale(),ypos22 * _this63.get__scale(),_this63.get__cellWidth() * _this63.get__scale(),_this63.get__cellHeight() * _this63.get__scale());
		var shiftX22 = _this63._currentSprite * _this63.get__cellWidth();
		var shiftY22 = 0;
		_this63._ctx.scale(_this63.get__scale(),_this63.get__scale());
		_this63._ctx.drawImage(_this63.get__img(),shiftX22,shiftY22,_this63.get__cellWidth(),_this63.get__cellHeight(),xpos22,ypos22,_this63.get__cellWidth(),_this63.get__cellHeight());
		_this63._ctx.restore();
		if(_this63._isAnimation) {
			_this63._currentSprite++;
			if(_this63._currentSprite > _this63._totalFrame) {
				if(_this63._isLoop) {
					if(_this63.get__isDebug()) {
						haxe_Log.trace("" + _this63.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this63._currentSprite = _this63.get__index();
				} else {
					if(_this63.get__isDebug()) {
						haxe_Log.trace("" + _this63.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this63._isAnimation = false;
					_this63._currentSprite = _this63._totalFrame - 1;
					if(_this63._isActive && _this63._pulse == null) {
						window.console.info("" + _this63.get__id() + " - this should happen only once! (" + _this63._pulse + " == null)");
						window.console.groupCollapsed("Spritesheet (" + _this63.get__id() + "):");
						window.console.warn("" + _this63.toString());
					...
					var ypos23 = 0;
					if(_this63.get__isCentered()) {
						xpos23 = -Math.round(_this63.get__cellWidth() / 2);
						ypos23 = -Math.round(_this63.get__cellHeight() / 2);
					}
					_this63._ctx.save();
					_this63._ctx.translate(_this63.get__x(),_this63.get__y());
					_this63._ctx.rotate(cc_util_MathUtil.radians(_this63.get__rotate()));
					_this63._ctx.clearRect(xpos23 * _this63.get__scale(),ypos23 * _this63.get__scale(),_this63.get__cellWidth() * _this63.get__scale(),_this63.get__cellHeight() * _this63.get__scale());
					var shiftX23 = _this63._currentSprite * _this63.get__cellWidth();
					var shiftY23 = 0;
					_this63._ctx.scale(_this63.get__scale(),_this63.get__scale());
					_this63._ctx.drawImage(_this63.get__img(),shiftX23,shiftY23,_this63.get__cellWidth(),_this63.get__cellHeight(),xpos23,ypos23,_this63.get__cellWidth(),_this63.get__cellHeight());
					_this63._ctx.restore();
					if(_this63._isAnimation) {
						_this63._currentSprite++;
						if(_this63._currentSprite > _this63._totalFrame) {
		...
		var spritesheet12 = new cc_draw_Spritesheet(this.ctx,this._img);
		var _this64 = spritesheet12;
		_this64.set__isDebug(this.isDebug);
		var _this65 = _this64;
		_this65.set__fps(30);
		var _this66 = _this65;
		_this66.set__cellWidth(100);
		_this66.set__cellHeight(100);
		_this66._totalFrame = Math.round(_this66.get__width() / _this66.get__cellWidth());
		var _this67 = _this66;
		_this67.set__scale(_scale);
		var _this68 = _this67;
		_this68.set__isCentered(true);
		var _this69 = _this68;
		var x = this.get_w3();
		var y1 = this.get_h3();
		_this69.set__x(x);
		_this69.set__y(y1);
		var _this70 = _this69;
		_this70._isAnimation = true;
		_this70._isActive = true;
		var _this71 = _this70;
		if(_this71._isActive && _this71._pulse == null) {
			window.console.info("" + _this71.get__id() + " - this should happen only once! (" + _this71._pulse + " == null)");
			window.console.groupCollapsed("Spritesheet (" + _this71.get__id() + "):");
			window.console.warn("" + _this71.toString());
			window.console.groupEnd();
			_this71._pulse = window.requestAnimationFrame($bind(_this71,_this71.pulseHandler));
		}
		var xpos24 = 0;
		var ypos24 = 0;
		if(_this71.get__isCentered()) {
			xpos24 = -Math.round(_this71.get__cellWidth() / 2);
			ypos24 = -Math.round(_this71.get__cellHeight() / 2);
		}
		_this71._ctx.save();
		_this71._ctx.translate(_this71.get__x(),_this71.get__y());
		_this71._ctx.rotate(cc_util_MathUtil.radians(_this71.get__rotate()));
		_this71._ctx.clearRect(xpos24 * _this71.get__scale(),ypos24 * _this71.get__scale(),_this71.get__cellWidth() * _this71.get__scale(),_this71.get__cellHeight() * _this71.get__scale());
		var shiftX24 = _this71._currentSprite * _this71.get__cellWidth();
		var shiftY24 = 0;
		_this71._ctx.scale(_this71.get__scale(),_this71.get__scale());
		_this71._ctx.drawImage(_this71.get__img(),shiftX24,shiftY24,_this71.get__cellWidth(),_this71.get__cellHeight(),xpos24,ypos24,_this71.get__cellWidth(),_this71.get__cellHeight());
		_this71._ctx.restore();
		if(_this71._isAnimation) {
			_this71._currentSprite++;
			if(_this71._currentSprite > _this71._totalFrame) {
				if(_this71._isLoop) {
					if(_this71.get__isDebug()) {
						haxe_Log.trace("" + _this71.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this71._currentSprite = _this71.get__index();
				} else {
					if(_this71.get__isDebug()) {
						haxe_Log.trace("" + _this71.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this71._isAnimation = false;
					_this71._currentSprite = _this71._totalFrame - 1;
					if(_this71._isActive && _this71._pulse == null) {
						window.console.info("" + _this71.get__id() + " - this should happen only once! (" + _this71._pulse + " == null)");
						window.console.groupCollapsed("Spritesheet (" + _this71.get__id() + "):");
						window.console.warn("" + _this71.toString());
					...
					var ypos25 = 0;
					if(_this71.get__isCentered()) {
						xpos25 = -Math.round(_this71.get__cellWidth() / 2);
						ypos25 = -Math.round(_this71.get__cellHeight() / 2);
					}
					_this71._ctx.save();
					_this71._ctx.translate(_this71.get__x(),_this71.get__y());
					_this71._ctx.rotate(cc_util_MathUtil.radians(_this71.get__rotate()));
					_this71._ctx.clearRect(xpos25 * _this71.get__scale(),ypos25 * _this71.get__scale(),_this71.get__cellWidth() * _this71.get__scale(),_this71.get__cellHeight() * _this71.get__scale());
					var shiftX25 = _this71._currentSprite * _this71.get__cellWidth();
					var shiftY25 = 0;
					_this71._ctx.scale(_this71.get__scale(),_this71.get__scale());
					_this71._ctx.drawImage(_this71.get__img(),shiftX25,shiftY25,_this71.get__cellWidth(),_this71.get__cellHeight(),xpos25,ypos25,_this71.get__cellWidth(),_this71.get__cellHeight());
					_this71._ctx.restore();
					if(_this71._isAnimation) {
						_this71._currentSprite++;
						if(_this71._currentSprite > _this71._totalFrame) {
		...
		var spritesheet13 = new cc_draw_Spritesheet(this.ctx,this._img);
		var _this72 = spritesheet13;
		_this72.set__isDebug(this.isDebug);
		var _this73 = _this72;
		_this73.set__fps(60);
		var _this74 = _this73;
		_this74.set__cellWidth(100);
		_this74.set__cellHeight(100);
		_this74._totalFrame = Math.round(_this74.get__width() / _this74.get__cellWidth());
		var _this75 = _this74;
		_this75.set__scale(_scale);
		var _this76 = _this75;
		_this76.set__isCentered(true);
		var _this77 = _this76;
		...
		_this77.set__y(y2);
		var _this78 = _this77;
		_this78._isAnimation = true;
		_this78._isActive = true;
		var _this79 = _this78;
		if(_this79._isActive && _this79._pulse == null) {
			window.console.info("" + _this79.get__id() + " - this should happen only once! (" + _this79._pulse + " == null)");
			window.console.groupCollapsed("Spritesheet (" + _this79.get__id() + "):");
			window.console.warn("" + _this79.toString());
			window.console.groupEnd();
			_this79._pulse = window.requestAnimationFrame($bind(_this79,_this79.pulseHandler));
		}
		var xpos26 = 0;
		var ypos26 = 0;
		if(_this79.get__isCentered()) {
			xpos26 = -Math.round(_this79.get__cellWidth() / 2);
			ypos26 = -Math.round(_this79.get__cellHeight() / 2);
		}
		_this79._ctx.save();
		_this79._ctx.translate(_this79.get__x(),_this79.get__y());
		_this79._ctx.rotate(cc_util_MathUtil.radians(_this79.get__rotate()));
		_this79._ctx.clearRect(xpos26 * _this79.get__scale(),ypos26 * _this79.get__scale(),_this79.get__cellWidth() * _this79.get__scale(),_this79.get__cellHeight() * _this79.get__scale());
		var shiftX26 = _this79._currentSprite * _this79.get__cellWidth();
		var shiftY26 = 0;
		_this79._ctx.scale(_this79.get__scale(),_this79.get__scale());
		_this79._ctx.drawImage(_this79.get__img(),shiftX26,shiftY26,_this79.get__cellWidth(),_this79.get__cellHeight(),xpos26,ypos26,_this79.get__cellWidth(),_this79.get__cellHeight());
		_this79._ctx.restore();
		if(_this79._isAnimation) {
			_this79._currentSprite++;
			if(_this79._currentSprite > _this79._totalFrame) {
				if(_this79._isLoop) {
					if(_this79.get__isDebug()) {
						haxe_Log.trace("" + _this79.get__id() + " - start loop",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 298, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this79._currentSprite = _this79.get__index();
				} else {
					if(_this79.get__isDebug()) {
						haxe_Log.trace("" + _this79.get__id() + " - stop animation",{ fileName : "cc/draw/Spritesheet.hx", lineNumber : 302, className : "cc.draw.Spritesheet", methodName : "draw"});
					}
					_this79._isAnimation = false;
					_this79._currentSprite = _this79._totalFrame - 1;
					if(_this79._isActive && _this79._pulse == null) {
						window.console.info("" + _this79.get__id() + " - this should happen only once! (" + _this79._pulse + " == null)");
						window.console.groupCollapsed("Spritesheet (" + _this79.get__id() + "):");
						window.console.warn("" + _this79.toString());
					...
					var ypos27 = 0;
					if(_this79.get__isCentered()) {
						xpos27 = -Math.round(_this79.get__cellWidth() / 2);
						ypos27 = -Math.round(_this79.get__cellHeight() / 2);
					}
					_this79._ctx.save();
					_this79._ctx.translate(_this79.get__x(),_this79.get__y());
					_this79._ctx.rotate(cc_util_MathUtil.radians(_this79.get__rotate()));
					_this79._ctx.clearRect(xpos27 * _this79.get__scale(),ypos27 * _this79.get__scale(),_this79.get__cellWidth() * _this79.get__scale(),_this79.get__cellHeight() * _this79.get__scale());
					var shiftX27 = _this79._currentSprite * _this79.get__cellWidth();
					var shiftY27 = 0;
					_this79._ctx.scale(_this79.get__scale(),_this79.get__scale());
					_this79._ctx.drawImage(_this79.get__img(),shiftX27,shiftY27,_this79.get__cellWidth(),_this79.get__cellHeight(),xpos27,ypos27,_this79.get__cellWidth(),_this79.get__cellHeight());
					_this79._ctx.restore();
					if(_this79._isAnimation) {
						_this79._currentSprite++;
						if(_this79._currentSprite > _this79._totalFrame) {
	...
	,onFontComplete: function(e) {
		haxe_Log.trace("onFontComplete: \"" + e + "\"",{ fileName : "src/art/CC055.hx", lineNumber : 160, className : "art.CC055", methodName : "onFontComplete"});
		this.isFontLoaded = true;
		this.drawShape();
	}
	,drawShape: function() {
	...
	,setup: function() {
		haxe_Log.trace("setup: " + this.toString(),{ fileName : "src/art/CC055.hx", lineNumber : 193, className : "art.CC055", methodName : "setup"});
		var colorArray = cc_util_ColorUtil.niceColor100SortedString[cc_util_MathUtil.randomInt(cc_util_ColorUtil.niceColor100SortedString.length - 1)];
		var int = Std.parseInt(StringTools.replace(colorArray[0],"#","0x"));
		this._color0 = { r : int >> 16 & 255, g : int >> 8 & 255, b : int & 255};
		var int1 = Std.parseInt(StringTools.replace(colorArray[1],"#","0x"));
	...
	,draw: function() {
		haxe_Log.trace("draw: " + this.toString(),{ fileName : "src/art/CC055.hx", lineNumber : 216, className : "art.CC055", methodName : "draw"});
		this.drawShape();
		this.stop();
	}
	,__class__: art_CC055
...
art_CC056.prototype = $extend(art_CCBase.prototype,{
	...
	,createQuickSettings: function() {
		this.panel1 = QuickSettings.create(10,10,"Quote generator").setGlobalChangeHandler($bind(this,this.drawShape)).addHTML("Reason","Sometimes I need a quick quote, to post on Instagram").addTextArea("Quote","text",function(value) {
			...
			haxe_Log.trace(value1,{ fileName : "src/art/CC056.hx", lineNumber : 52, className : "art.CC056", methodName : "createQuickSettings"});
		}).saveInLocalStorage("store-data-" + this.toString());
	}
	,createShape: function(i,point) {
...
art_CC059.prototype = $extend(art_CCBase.prototype,{
	...
	,onAnimateHandler: function(sh,id,count) {
		...
		var _this2 = _this1._props;
		if(__map_reserved["degree"] != null) {
			_this2.setReserved("degree",_range);
		} else {
			_this2.h["degree"] = _range;
		}
		if(_this1._isFrom) {
			_this1.updateProperties(0);
		}
...
art_CC059b.prototype = $extend(art_CCBase.prototype,{
	...
	,onAnimateHandler: function(sh,id,count) {
		...
		_this3._easing = cc_lets_easing_Sine.get_easeInOut();
		var _this4 = _this3;
		_this4._options.onComplete = $bind(this,this.onAnimateHandler2);
		_this4._options.onCompleteParams = [sh,id,count++];
	}
	,onAnimateHandler2: function(sh,id,count) {
		...
		var _this1 = _this._props;
		if(__map_reserved["degree"] != null) {
			_this1.setReserved("degree",_range);
		} else {
			_this1.h["degree"] = _range;
		}
		if(_this._isFrom) {
			_this.updateProperties(0);
		}
...
art_CC060.prototype = $extend(art_CCBase.prototype,{
	...
	,onHeartYoyoHandler: function(sh) {
		...
		var _this1 = _this._props;
		if(__map_reserved["size"] != null) {
			_this1.setReserved("size",_range);
		} else {
			_this1.h["size"] = _range;
		}
		if(_this._isFrom) {
			_this.updateProperties(0);
		}
		...
		var _this4 = _this3;
		_this4._options.onComplete = $bind(this,this.onHeartYoyoHandler);
		_this4._options.onCompleteParams = [sh];
	}
	,onShowCursorHandler: function(sh) {
		...
		var _this5 = _this3;
		_this5._easing = cc_lets_easing_Quart.get_easeInOut();
		var _this6 = _this5;
		_this6._options.onComplete = $bind(this,this.onHideCursorHandler);
		_this6._options.onCompleteParams = [this.cursorObj];
	}
	...
	,drawShape: function() {
		...
		if(_this6._ctx != null) {
			...
			var tmp1 = "" + _this6._css + " " + _this6.get__size() + "px " + _this6._font;
			_this6._ctx.font = StringTools.ltrim(tmp1);
			...
			if(!isLines) {
				...
				var _g2 = 0;
				var _g11 = _this6._lineArray.length;
				while(_g2 < _g11) {
					var i1 = _g2++;
			...
			var isLines1 = _this6.splitLines();
			var text = _this6._sketcher.makeText(_this6._text,_this6.get__x(),_this6.get__y());
			if(_this6.get__id() != null) {
				text.set_id(_this6.get__id());
			}
			if(_this6._color != null) {
				text.set_fill(cc_util_ColorUtil.getColourObj(_this6._color,_this6.get__alpha()));
			}
			text.set_fontSize("" + _this6.get__size() + "px");
			text.set_fontFamily("" + _this6._font);
			text._textAlign = _this6._textAlign;
			text._textBaseline = _this6._textBaseline;
			if(_this6.fontWeight != null) {
				text.set_fontWeight("" + _this6._fontWeight);
			}
			_this6._hackText = text;
		}
		var text1 = _this6;
		...
		var Text2 = new cc_draw_Text(this.ctx,"this post and you\nwill be featured in\nthe next animation!".toUpperCase());
		var _this8 = Text2;
		_this8.set__x(xpos1);
		_this8.set__y(ypos1);
		var _this9 = _this8;
		...
		if(_this14._ctx != null) {
			...
			var tmp3 = "" + _this14._css + " " + _this14.get__size() + "px " + _this14._font;
			_this14._ctx.font = StringTools.ltrim(tmp3);
			...
			if(!isLines2) {
				...
				var _g3 = 0;
				var _g12 = _this14._lineArray.length;
				while(_g3 < _g12) {
					var i2 = _g3++;
			...
			var isLines3 = _this14.splitLines();
			var text2 = _this14._sketcher.makeText(_this14._text,_this14.get__x(),_this14.get__y());
			if(_this14.get__id() != null) {
				text2.set_id(_this14.get__id());
			}
			if(_this14._color != null) {
				text2.set_fill(cc_util_ColorUtil.getColourObj(_this14._color,_this14.get__alpha()));
			}
			text2.set_fontSize("" + _this14.get__size() + "px");
			text2.set_fontFamily("" + _this14._font);
			text2._textAlign = _this14._textAlign;
			text2._textBaseline = _this14._textBaseline;
			if(_this14.fontWeight != null) {
				text2.set_fontWeight("" + _this14._fontWeight);
			}
			_this14._hackText = text2;
		}
		var text3 = _this14;
	...
	,setup: function() {
		...
		var _this3 = _this2;
		var isDebug1 = this.isDebug;
		if(isDebug1 == null) {
			isDebug1 = true;
		}
		_this3.set__isDebug(isDebug1);
		var _this4 = _this3;
		if(_this4.get__isDebug()) {
...
art_CC062.prototype = $extend(art_CCBase.prototype,{
	...
	,onAnimateHandler: function(sh,id,count) {
		...
		var _this4 = _this3;
		_this4._options.onComplete = $bind(this,this.onAnimateHandler2);
		_this4._options.onCompleteParams = [sh,id,count + 3];
	}
	,onAnimateHandler2: function(sh,id,count) {
...
art_CC063.prototype = $extend(art_CCBase.prototype,{
	...
	,drawShape: function() {
		...
		var _g4 = 0;
		var _g5 = this.shapeArray2.length;
		while(_g4 < _g5) {
			var i2 = _g4++;
...
art_CC064.prototype = $extend(art_CCBase.prototype,{
	...
	,onAnimationContinue: function(sh,id,count) {
		...
		if(__map_reserved["angle"] != null) {
			_this2.setReserved("angle",_range);
		} else {
			_this2.h["angle"] = _range;
		}
		if(_this1._isFrom) {
			_this1.updateProperties(0);
		}
...
art_CC065.prototype = $extend(art_CCBase.prototype,{
	...
	,onAnimationContinue: function(sh,id,count) {
		...
		if(__map_reserved["scale"] != null) {
			_this2.setReserved("scale",_range);
		} else {
			_this2.h["scale"] = _range;
		}
		if(_this1._isFrom) {
			_this1.updateProperties(0);
		}
		...
		_this3._isYoyo = true;
		var _this4 = _this3;
		_this4._easing = cc_lets_easing_Elastic.get_easeInOut();
		var _this5 = _this4;
		_this5._options.onComplete = $bind(this,this.onAnimationContinue);
		_this5._options.onCompleteParams = [sh,id,++count];
	}
	,drawShape: function() {
		this.ctx.clearRect(0,0,Global.w,Global.h);
		cc_CanvasTools.backgroundObj(this.ctx,cc_util_ColorUtil.WHITE);
...
art_CC066.prototype = $extend(art_CCExportBase.prototype,{
	...
	,onAnimationHandler: function(line) {
		...
		_this2._easing = cc_lets_easing_Sine.get_easeInOut();
		var _this3 = _this2;
		_this3._options.onComplete = $bind(this,this.onAnimationHandler);
		_this3._options.onCompleteParams = [line];
	}
	,setup: function() {
		var _g = 0;
...
art_CC067.prototype = $extend(art_CCExportBase.prototype,{
	...
	,onAnimateHandler: function(circle) {
		...
		_go1._options.onComplete = function() {
			...
			var _go2 = 1 + Math.random();
			var _go3 = new cc_lets_Go(target1,_go2);
			_go3._isWiggle = true;
			var max1 = wiggleRoom1;
			var min1 = -wiggleRoom1;
			var value4 = Math.random() * (max1 - min1);
			var value5 = x1 + value4 + min1;
			var objValue2 = 0;
			if(Object.prototype.hasOwnProperty.call(_go3._target,"x")) {
				objValue2 = Reflect.getProperty(_go3._target,"x");
			}
			var _range2 = { key : "x", from : _go3._isFrom ? value5 : objValue2, to : !_go3._isFrom ? value5 : objValue2};
			var _this2 = _go3._props;
			if(__map_reserved["x"] != null) {
			...
			if(_go3._isFrom) {
				_go3.updateProperties(0);
			}
			var value6 = Math.random() * (max1 - min1);
			var value7 = y1 + value6 + min1;
			var objValue3 = 0;
			if(Object.prototype.hasOwnProperty.call(_go3._target,"y")) {
				objValue3 = Reflect.getProperty(_go3._target,"y");
			}
			var _range3 = { key : "y", from : _go3._isFrom ? value7 : objValue3, to : !_go3._isFrom ? value7 : objValue3};
			var _this3 = _go3._props;
			if(__map_reserved["y"] != null) {
				_this3.setReserved("y",_range3);
			} else {
				_this3.h["y"] = _range3;
			}
			if(_go3._isFrom) {
			...
			_go3._easing = cc_lets_easing_Sine.get_easeInOut();
			_go3._options.onComplete = function() {
				cc_lets_Go.wiggle(target1,x1,y1,wiggleRoom1);
			};
			_go3._options.onCompleteParams = null;
		};
	...
	,onAnimateHandler: function(sh,i) {
		...
		if(z != null) {
			...
			if(Object.prototype.hasOwnProperty.call(_this1._target,"z")) {
				objValue2 = Reflect.getProperty(_this1._target,"z");
			}
			var _range2 = { key : "z", from : _this1._isFrom ? z : objValue2, to : !_this1._isFrom ? z : objValue2};
			var _this4 = _this1._props;
			if(__map_reserved["z"] != null) {
				_this4.setReserved("z",_range2);
			} else {
				_this4.h["z"] = _range2;
			}
			if(_this1._isFrom) {
		...
		_this5._isYoyo = true;
		var _this6 = _this5;
		_this6._easing = cc_lets_easing_Sine.get_easeInOut();
		var _this7 = _this6;
		_this7._options.onComplete = $bind(this,this.onAnimateHandler);
		_this7._options.onCompleteParams = [sh,i];
	}
	,drawShape: function() {
		this.ctx.clearRect(0,0,Global.w,Global.h);
		cc_CanvasTools.backgroundObj(this.ctx,cc_util_ColorUtil.WHITE);
...
art_CC070.prototype = $extend(art_CCExportBase.prototype,{
	...
	,createQuickSettings: function() {
		this.panel1 = QuickSettings.create(10,10,"Quote generator").setGlobalChangeHandler($bind(this,this.drawShape)).addHTML("Reason","Sometimes I need a quick quote, to post on Instagram").addTextArea("Quote","text",function(value) {
			...
			haxe_Log.trace(value1,{ fileName : "src/art/CC070.hx", lineNumber : 52, className : "art.CC070", methodName : "createQuickSettings"});
		}).saveInLocalStorage("store-data-" + this.toString());
	}
	,createShape: function(i,point) {
		var shape = { _id : "" + i, _type : "circle", x : point.x, y : point.y, radius : this._radius};
	...
	,drawShape: function() {
		...
		if(_this7._ctx != null) {
			...
			if(!isLines) {
				...
				var _g2 = 0;
				var _g11 = _this7._lineArray.length;
				while(_g2 < _g11) {
					var i1 = _g2++;
			...
			text._textAlign = _this7._textAlign;
			text._textBaseline = _this7._textBaseline;
...
art_CC071.prototype = $extend(art_CCBase.prototype,{
	createQuickSettings: function() {
		this.panel1 = QuickSettings.create(10,10,"Quote generator").setGlobalChangeHandler($bind(this,this.drawShape)).addHTML("Reason","Sometimes I need a quick quote, to post on Instagram").addTextArea("Quote","text",function(value) {
			...
			haxe_Log.trace(value1,{ fileName : "src/art/CC071.hx", lineNumber : 43, className : "art.CC071", methodName : "createQuickSettings"});
		}).saveInLocalStorage("store-data-" + this.toString());
	}
	,createShape: function(i,point) {
		var shape = { _id : "" + i, _type : "circle", x : point.x, y : point.y, radius : this._radius};
	...
	,textLoader: function(_l) {
		...
		req.onData = function(data) {
			try {
				...
				var e1 = ((e) instanceof js__$Boot_HaxeError) ? e.val : e;
				if(_gthis.get__isDebug()) {
					haxe_Log.trace(e1,{ fileName : "cc/tool/Loader.hx", lineNumber : 253, className : "cc.tool.Loader", methodName : "textLoader"});
				}
				_gthis._loadCounter++;
				_gthis.loadingHandler();
			}
...
var cc_tool_FileType = $hxEnums["cc.tool.FileType"] = { __ename__ : true, __constructs__ : ["Unknown","Img","IMG","Txt","TXT","Json","JSON","Gif","GIF","Png","PNG","JPEG","JPG","Xml","XML","Svg","SVG","Csv","CSV"]
	,Unknown: {_hx_index:0,__enum__:"cc.tool.FileType",toString:$estr}
	,Img: {_hx_index:1,__enum__:"cc.tool.FileType",toString:$estr}
	,IMG: {_hx_index:2,__enum__:"cc.tool.FileType",toString:$estr}
	,Txt: {_hx_index:3,__enum__:"cc.tool.FileType",toString:$estr}
	,TXT: {_hx_index:4,__enum__:"cc.tool.FileType",toString:$estr}
	,Json: {_hx_index:5,__enum__:"cc.tool.FileType",toString:$estr}
	,JSON: {_hx_index:6,__enum__:"cc.tool.FileType",toString:$estr}
	,Gif: {_hx_index:7,__enum__:"cc.tool.FileType",toString:$estr}
	,GIF: {_hx_index:8,__enum__:"cc.tool.FileType",toString:$estr}
	,Png: {_hx_index:9,__enum__:"cc.tool.FileType",toString:$estr}
	,PNG: {_hx_index:10,__enum__:"cc.tool.FileType",toString:$estr}
	,JPEG: {_hx_index:11,__enum__:"cc.tool.FileType",toString:$estr}
	,JPG: {_hx_index:12,__enum__:"cc.tool.FileType",toString:$estr}
	,Xml: {_hx_index:13,__enum__:"cc.tool.FileType",toString:$estr}
	,XML: {_hx_index:14,__enum__:"cc.tool.FileType",toString:$estr}
	,Svg: {_hx_index:15,__enum__:"cc.tool.FileType",toString:$estr}
	,SVG: {_hx_index:16,__enum__:"cc.tool.FileType",toString:$estr}
	,Csv: {_hx_index:17,__enum__:"cc.tool.FileType",toString:$estr}
	,CSV: {_hx_index:18,__enum__:"cc.tool.FileType",toString:$estr}
};
...
cc_tool_export_ExportNodeServer.prototype = $extend(cc_tool_export_ExportWrapperBase.prototype,{
	...
	,initSocket: function() {
		...
		this._socket.on("connect",function(err1) {
			if(err1 == "undefined") {
				haxe_Log.trace("" + _gthis.toString() + " connect: " + err1,{ fileName : "cc/tool/export/ExportNodeServer.hx", lineNumber : 159, className : "cc.tool.export.ExportNodeServer", methodName : "initSocket"});
			} else {
		...
		this._socket.on("disconnect",function(err2) {
			haxe_Log.trace("" + _gthis.toString() + " disconnect: " + err2,{ fileName : "cc/tool/export/ExportNodeServer.hx", lineNumber : 168, className : "cc.tool.export.ExportNodeServer", methodName : "initSocket"});
		});
		this._socket.on("connect_failed",function(err3) {
			haxe_Log.trace("" + _gthis.toString() + " connect_failed: " + err3,{ fileName : "cc/tool/export/ExportNodeServer.hx", lineNumber : 173, className : "cc.tool.export.ExportNodeServer", methodName : "initSocket"});
		});
		this._socket.on("error",function(err4) {
			haxe_Log.trace("" + _gthis.toString() + " error: " + err4,{ fileName : "cc/tool/export/ExportNodeServer.hx", lineNumber : 176, className : "cc.tool.export.ExportNodeServer", methodName : "initSocket"});
		});
		...
		this._socket.on(cc_tool_export_ExportNames.SERVER_CHECKIN,function(data1) {
			if(data1.checkin != null && data1.checkin == true) {
				...
				window.console.log("" + _gthis.toString() + " data:  + " + Std.string(data1) + ", & _isExportServerReady: " + Std.string(_gthis._isExportServerReady));
			} else {
...
var cc_tool_export_ExportType = $hxEnums["cc.tool.export.ExportType"] = { __ename__ : true, __constructs__ : ["ZIP","NODE","NONE","TEST"]
	,ZIP: {_hx_index:0,__enum__:"cc.tool.export.ExportType",toString:$estr}
	,NODE: {_hx_index:1,__enum__:"cc.tool.export.ExportType",toString:$estr}
	,NONE: {_hx_index:2,__enum__:"cc.tool.export.ExportType",toString:$estr}
	,TEST: {_hx_index:3,__enum__:"cc.tool.export.ExportType",toString:$estr}
};
...
draw_PolyLine.prototype = $extend(draw_Base.prototype,{
	svg: function(settings) {
		...
		if(this.getTransform() != "") {
			haxe_Log.trace(this.getTransform(),{ fileName : "draw/PolyLine.hx", lineNumber : 30, className : "draw.PolyLine", methodName : "svg"});
			this.xml.set("transform",this.getTransform());
		}
		return haxe_xml_Printer.print(this.xml);
	}
...
hxColorToolkit_ColorToolkit.rybRotate = function(color,angle) {
	...
	var a = 0;
	var _g = 0;
	var _g1 = hxColorToolkit_ColorToolkit.rybWheel.length;
	while(_g < _g1) {
		var i = _g++;
	...
	var newHue = 0;
	var _g2 = 0;
	var _g3 = hxColorToolkit_ColorToolkit.rybWheel.length;
	while(_g2 < _g3) {
		var k = _g2++;
...
hxColorToolkit_schemes_ColorScheme.__isInterface__ = true;
...
hxColorToolkit_schemes_Analogous.prototype = $extend(hxColorToolkit_schemes_ColorWheelScheme.prototype,{
	...
	,generate: function() {
		...
		var _primaryHSB;
		if(((this.get_primaryColor()) instanceof hxColorToolkit_spaces_HSB)) {
...
hxColorToolkit_spaces_Color.__isInterface__ = true;
...
hxColorToolkit_spaces_RGB.prototype = {
	...
	,interpolate: function(target,ratio) {
		...
		var target1 = ((target) instanceof hxColorToolkit_spaces_RGB) ? target : new hxColorToolkit_spaces_RGB().fromRGB(target.toRGB());
...
hxColorToolkit_spaces_ARGB.prototype = $extend(hxColorToolkit_spaces_RGB.prototype,{
	...
	,interpolate: function(target,ratio) {
		...
		var target1 = ((target) instanceof hxColorToolkit_spaces_ARGB) ? target : new hxColorToolkit_spaces_ARGB().fromRGB(target.toRGB());
...
hxColorToolkit_spaces_CMYK.prototype = {
	...
	,interpolate: function(target,ratio) {
		...
		var target1 = ((target) instanceof hxColorToolkit_spaces_CMYK) ? target : new hxColorToolkit_spaces_CMYK().fromRGB(target.toRGB());
...
hxColorToolkit_spaces_Gray.prototype = {
	...
	,interpolate: function(target,ratio) {
		...
		var target1 = ((target) instanceof hxColorToolkit_spaces_Gray) ? target : new hxColorToolkit_spaces_Gray().fromRGB(target.toRGB());
...
hxColorToolkit_spaces_HSB.prototype = {
	...
	,interpolate: function(target,ratio) {
		...
		var target1 = ((target) instanceof hxColorToolkit_spaces_HSB) ? target : new hxColorToolkit_spaces_HSB().fromRGB(target.toRGB());
...
hxColorToolkit_spaces_HSL.prototype = {
	...
	,interpolate: function(target,ratio) {
		...
		var target1 = ((target) instanceof hxColorToolkit_spaces_HSL) ? target : new hxColorToolkit_spaces_HSL().fromRGB(target.toRGB());
...
hxColorToolkit_spaces_Hex.prototype = {
	...
	,interpolate: function(target,ratio) {
		...
		var target1 = ((target) instanceof hxColorToolkit_spaces_Hex) ? target : new hxColorToolkit_spaces_Hex(target.getColor());
...
hxColorToolkit_spaces_Lab.prototype = {
	...
	,interpolate: function(target,ratio) {
		...
		var target1 = ((target) instanceof hxColorToolkit_spaces_Lab) ? target : new hxColorToolkit_spaces_Lab().fromRGB(target.toRGB());
...
hxColorToolkit_spaces_XYZ.prototype = {
	...
	,interpolate: function(target,ratio) {
		...
		var target1 = ((target) instanceof hxColorToolkit_spaces_XYZ) ? target : new hxColorToolkit_spaces_XYZ().fromRGB(target.toRGB());
...
hxColorToolkit_spaces_YUV.prototype = {
	...
	,interpolate: function(target,ratio) {
		...
		var target1 = ((target) instanceof hxColorToolkit_spaces_YUV) ? target : new hxColorToolkit_spaces_YUV().fromRGB(target.toRGB());
...
lib_model_constants_Onom.prototype = {
	getChar: function(value) {
		...
		if(__map_reserved[value] != null ? _this.existsReserved(value) : _this.h.hasOwnProperty(value)) {
			...
			pointsArray = __map_reserved[value] != null ? _this1.getReserved(value) : _this1.h[value];
		}
		var temp = [];
		var _g = 0;
...
mloader_HttpLoader.prototype = $extend(mloader_LoaderBase.prototype,{
	send: function(data) {
		...
		try {
			...
			this.loaderFail(mloader_LoaderErrorType.Security(Std.string(((e) instanceof js__$Boot_HaxeError) ? e.val : e)));
		}
	}
	,loaderLoad: function() {
		this.httpConfigure();
...
mloader_JsonLoader.prototype = $extend(mloader_HttpLoader.prototype,{
	httpData: function(data) {
		...
		try {
			...
			this.loaderFail(mloader_LoaderErrorType.Format(Std.string(((e) instanceof js__$Boot_HaxeError) ? e.val : e)));
			return;
		}
		...
		try {
			...
			var e2 = ((e1) instanceof js__$Boot_HaxeError) ? e1.val : e1;
			if(js_Boot.__instanceof(e2,mloader_LoaderErrorType)) {
				this.loaderFail(e2);
				return;
			} else {
				this.loaderFail(mloader_LoaderErrorType.Data(Std.string(e2),data));
				return;
			}
		}
	}
...
var mloader_LoaderEventType = $hxEnums["mloader.LoaderEventType"] = { __ename__ : true, __constructs__ : ["Start","Cancel","Progress","Complete","Fail"]
	,Start: {_hx_index:0,__enum__:"mloader.LoaderEventType",toString:$estr}
	,Cancel: {_hx_index:1,__enum__:"mloader.LoaderEventType",toString:$estr}
	,Progress: {_hx_index:2,__enum__:"mloader.LoaderEventType",toString:$estr}
	,Complete: {_hx_index:3,__enum__:"mloader.LoaderEventType",toString:$estr}
	,Fail: ($_=function(error) { return {_hx_index:4,error:error,__enum__:"mloader.LoaderEventType",toString:$estr}; },$_.__params__ = ["error"],$_)
};
var mloader_LoaderErrorType = $hxEnums["mloader.LoaderErrorType"] = { __ename__ : true, __constructs__ : ["IO","Security","Format","Data"]
	,IO: ($_=function(info) { return {_hx_index:0,info:info,__enum__:"mloader.LoaderErrorType",toString:$estr}; },$_.__params__ = ["info"],$_)
	,Security: ($_=function(info) { return {_hx_index:1,info:info,__enum__:"mloader.LoaderErrorType",toString:$estr}; },$_.__params__ = ["info"],$_)
	,Format: ($_=function(info) { return {_hx_index:2,info:info,__enum__:"mloader.LoaderErrorType",toString:$estr}; },$_.__params__ = ["info"],$_)
	,Data: ($_=function(info,data) { return {_hx_index:3,info:info,data:data,__enum__:"mloader.LoaderErrorType",toString:$estr}; },$_.__params__ = ["info","data"],$_)
};
